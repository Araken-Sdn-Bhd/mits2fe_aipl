            ...
            <div class="project-location-mentari profess-box hide">
              <div class="mt-3">
                <select class="form-select">
                  <option selected>Please Select Which Mentari</option>
    ...
    async OnSubmit() {
      ...
      if (this.is_agree) {
        if (this.area_of_involvement == "Volunteerism") {
          ...
          window.alert("Outreach Project Collaboration");
        } else if (
          this.area_of_involvement == "Networking Make a Contribution"
        ) {
          window.alert("Networking Make a Contribution");
        } else {
    ...
    async OnIndividualVolunteerism() {
      try {
        ...
        if (
          ...
          body.append("is_agree", this.is_agree);
