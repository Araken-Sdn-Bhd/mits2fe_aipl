          ...
          <div class="card mb-4">
            <div class="card-body new-form">
              ...
              <table class="notes th-width table-padding">
                <tbody>
                  <tr>
                    <th style="width: 80%">1. Do you have interest to work?</th>
                    <td>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="1" id="1.1" v-model="interest_to_work" />
                  ...
                  <tr>
                    <th style="width: 80%">
                      2. Do you agree if MENTARI find a job for you?
                    </th>
                    <td>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="1" id="1.2"
                          v-model="agree_if_mentari_find_job_for_you" />
              ...
              <p class="title-th">3. Client job preferences?</p>
                ...
                <table class="th-auto th-bg">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Clerk/ Office</td>
                      <td>
                        <input type="checkbox" name="" value="Clerk Job" v-model="clerk_job_interester" />Yes
                      </td>
                      <td>
                        <input type="text" class="form-control" name="" v-model="clerk_job_notes" />
                      </td>
                    </tr>
                    <tr>
                      <td>2</td>
                      ...
                      <td>
                        <input type="checkbox" name="" value="Factory Worker"
                          v-model="factory_worker_job_interested" />Yes
                      </td>
                      <td>
                        <input type="text" class="form-control" name="" v-model="factory_worker_notes" />
                      </td>
                    </tr>
                    <tr>
                      <td>3</td>
                      <td>Cleaner</td>
                      <td>
                        <input type="checkbox" name="" value="Cleaner" v-model="cleaner_job_interested" />Yes
                      </td>
                      <td>
                        <input type="text" class="form-control" name="" v-model="cleaner_job_notes" />
                      </td>
                    </tr>
                    <tr>
                      <td>4</td>
                      ...
                      <td>
                        <input type="checkbox" name="" value="Security Guard"
                          v-model="security_guard_job_interested" />Yes
                      </td>
                      <td>
                        <input type="text" class="form-control" name="" v-model="security_guard_notes" />
                      </td>
                    </tr>
                    <tr>
                      <td>5</td>
                      ...
                      <td>
                        <input type="checkbox" name="" value="Laundry Worker"
                          v-model="laundry_worker_job_interested" />Yes
                      </td>
                      <td>
                        <input type="text" class="form-control" name="" v-model="laundry_worker_notes" />
                      </td>
                    </tr>
                    <tr>
                      <td>6</td>
                      ...
                      <td>
                        <input type="checkbox" name="" value="Car Wash" v-model="car_wash_worker_job" />Yes
                      </td>
                      <td>
                        <input type="text" class="form-control" name="" v-model="car_wash_worker_notes" />
                      </td>
                    </tr>
                    <tr>
                      <td>7</td>
                      ...
                      <td>
                        <input type="checkbox" name="" value="Kitchen Helper" v-model="kitchen_helper_job" />Yes
                      </td>
                      <td>
                        <input type="text" class="form-control" name="" v-model="kitchen_helper_notes" />
                      </td>
                    </tr>
                    <tr>
                      <td>8</td>
                      <td>Waiter</td>
                      <td>
                        <input type="checkbox" name="" value="Waiter" v-model="waiter_job_interested" />Yes
                      </td>
                      <td>
                        <input type="text" class="form-control" name="" v-model="waiter_job_notes" />
                      </td>
                    </tr>
                    <tr>
                      <td>9</td>
                      <td>Chef</td>
                      <td>
                        <input type="checkbox" name="" value="Chef" v-model="chef_job_interested" />Yes
                      </td>
                      <td>
                        <input type="text" class="form-control" name="" v-model="chef_job_notes" />
                      </td>
                    </tr>
                    <tr>
                      <td>10</td>
                      ...
                      <td>
                        <input type="checkbox" name="" value="Others" v-model="others_job_specify" />Yes
                      </td>
                      <td>
                        <input type="text" class="form-control" name="" v-model="others_job_notes" />
                      </td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <p class="title-th">4. Previous job?</p>
                ...
                <table class="th-auto th-bg input-width" id="job" v-if="!pid">
                  ...
                  <tbody class="optionBox">
                    <tr class="block">
                      <td>1</td>
                      <td>
                        <input type="text" class="form-control job" name="" />
                      </td>
                      <td>
                        <input type="text" class="form-control duration" name="" />
                      </td>
                      <td>
                ...
                <table class="th-auto th-bg input-width" id="job1" v-if="pid">
                  ...
                  <tbody class="optionBox1">
                    <tr class="block1" v-for="(job1, index) in jobs" :key="index">
                      ...
                      <td>
                        <input type="text" class="form-control duration" name="" v-model="job1.duration" />
                      </td>
                      <td>
                        <input type="text" class="form-control reason" name="" v-model="job1.termination_reason" />
                      </td>
                      <td>
                        <span class="add-td"><i class="fa fa-plus"></i></span>
                      </td>
              ...
              <table class="notes table-padding mobile-table">
                <tbody>
                  <tr>
                    <th>Note:</th>
                    <td>
                      <textarea class="form-control textarea mt-3" rows="2" placeholder="Enter Description"
              ...
              <div class="form-title mt-3">
                ...
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="1" id="set-as-headquarters"
                    v-model="patient_consent_interested" />
                  <label class="form-check-label" for="set-as-headquarters">
                    I am interested to join this supported employment program
                  </label>
                </div>
              </div>
              ...
              <div class="d-flex three-btn" v-if="!pid">
                <button @click="GoBack" class="btn btn-primary btn-text" title="Back"><i
  ...
  methods: {
    ...
    async getdetails() {
      ...
      if (response.data.code == 200) {
        ...
        this.cleaner_job_interested =
          response.data.Data[0].cleaner_job_interested;
        this.cleaner_job_notes = response.data.Data[0].cleaner_job_notes;
        this.security_guard_job_interested =
          response.data.Data[0].security_guard_job_interested;
        this.security_guard_notes = response.data.Data[0].security_guard_notes;
        this.laundry_worker_job_interested =
          response.data.Data[0].laundry_worker_job_interested;
        ...
        this.car_wash_worker_notes =
          response.data.Data[0].car_wash_worker_notes;
        ...
        this.waiter_job_interested =
          response.data.Data[0].waiter_job_interested;
