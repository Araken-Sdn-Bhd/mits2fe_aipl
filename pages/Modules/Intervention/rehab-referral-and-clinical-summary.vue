                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" v-model="patient_referred_for" value="Consultation/Screening" />
                                            <label class="form-check-label" for="exampleRadios1">
                                                Consultation/Screening
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios2" v-model="patient_referred_for" value="Counselling" />
                                            <label class="form-check-label" for="exampleRadios2">
                                                Counselling
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios3" v-model="patient_referred_for" value="Supported Employment" />
                                            <label class="form-check-label" for="exampleRadios3">
                                                Supported Employment*
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios4" v-model="patient_referred_for" value="Job Club" />
                                            <label class="form-check-label" for="exampleRadios4">
                                                Job Club*
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios5" v-model="patient_referred_for" value="ETP" />
                        ...
                        <table class="notes notes-sub">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="date" class="form-control" name="" v-model="date_onset" :disabled="isDisabled" />
                                    </td>
                                </tr>
                                <tr>
                                    <th>Date Of Referral<small style="color:red">*</small> :</th>
                                    <td>
                                        <input type="date" class="form-control" name="" v-model="date_of_referral" :disabled="isDisabled" />
                                    </td>
                                </tr>
                                <tr>
                                    <th>No. Of Admission<small style="color:red">*</small> :</th>
                                    <td>
                                        <input type="text" class="form-control" name="" v-model="no_of_admission" :disabled="isDisabled" />
                                    </td>
                                </tr>
                                <tr>
                                    <th>Latest Admission Date<small style="color:red">*</small> :</th>
                                    <td>
                                        <input type="date" class="form-control" name="" v-model="latest_admission_date" :disabled="isDisabled" />
                                    </td>
                                </tr>
                                <tr>
                                    <th>Current Medication<small style="color:red">*</small> :</th>
                                    <td>
                                        <textarea class="form-control textarea" v-model="current_medication"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td v-if="!pid">
                                        <div class="form-check form-check-inline">
                                            <input :disabled="isDisabled" class="form-check-input" type="checkbox" id="inlineCheckbox1" value="NMS" @click="OnAlert('NMS')" />
                                            <label class="form-check-label" for="inlineCheckbox1">NMS</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input :disabled="isDisabled" class="form-check-input" type="checkbox" id="inlineCheckbox2" value="SUICIDE" @click="OnAlert('SUICIDE')" />
                                            <label class="form-check-label" for="inlineCheckbox2">SUICIDE</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input :disabled="isDisabled" class="form-check-input" type="checkbox" id="inlineCheckbox3" value="FORENSIC" @click="OnAlert('FORENSIC')" />
                                            <label class="form-check-label" for="inlineCheckbox3">FORENSIC</label>
                                        </div>
                                    </td>
                                    <td v-if="pid">
                                        <div class="form-check form-check-inline" v-for="(alert,index) in alertlist" :key="index">
                                            <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="NMS" checked />
                                            <label class="form-check-label" for="inlineCheckbox1"> {{alert}} </label>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th>
                                        ...
                                        <em><i><small>That you feel will help this person reach his
                                                    employment goal, if any</small></i></em>
                                    </th>
                                    <td>
                                        <textarea class="form-control textarea" placeholder="Please type here.." v-model="other_information"></textarea>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-select" v-model="location_services" :disabled="isDisabled">
                                                    <option value="0">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-select" v-model="complexity_services" :disabled="isDisabled">
                                                    <option value="0">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea v-model="medication_prescription" class="form-control textarea" placeholder="Please Type Prescription Here" :disabled="isDisabled"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <table class="notes">
                            <tbody>
                                <tr>
                                    ...
                                    <td><input disabled type="text" class="form-control" name="" v-model="referral_name" /></td>
                                </tr>
                                <tr>
                                    <th>Designation<small style="color:red">*</small> :</th>
                                    <td><input disabled type="text" class="form-control" name="" v-model="designation" /></td>
                                </tr>
                            </tbody>
                        </table>
