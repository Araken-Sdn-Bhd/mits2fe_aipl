            ...
            <div class="card mb-4">
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                              <div class="form-check form-check-inline">
                                                  <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1"  v-model="patient_acknowledged" value="Yes" disabled>
                                                  <label class="form-check-label" for="inlineRadio1">Yes</label>
                                              </div>
                                              <div class="form-check form-check-inline">
                                                  <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" v-model="patient_acknowledged" value="No" disabled>
              ...
              {{ catcode.icd_code }} {{catcode.icd_name}}
                              ...
                              <tr>
                                <td>
                                  ...
                                  <div class="form-check">
                                    ...
                                    value="IQ Test" v-model="iqtest" id="asm-1">
                                  ...
                                  <div class="form-check">
                                    <input class="form-check-input" type="checkbox" disabled
                                    value="Psychosocial" v-model="psychosocial" id="asm-2">
                                  ...
                                  <div class="form-check">
                                    <input class="form-check-input" type="checkbox" disabled
                                    value="Neuropsychology" v-model="neuropsychology" id="asm-3">
                                ...
                                <td>
                                  ...
                                  <div class="form-check">
                                    <input class="form-check-input" type="checkbox" disabled
                                    value="Coping Mechanism and Skill" v-model="coping" id="asm-4">
                                  ...
                                  <div class="form-check">
                                    <input class="form-check-input" type="checkbox" disabled
                                    value="Personality Test" v-model="personaltest" id="asm-5">
                              ...
                              <tr>
                                <td>
                                  ...
                                  <div class="form-check">
                                    ...
                                    value="Psychoterapy" v-model="psychoterapy" id="int-1" disabled>
                                  ...
                                  <div class="form-check">
                                    <input class="form-check-input" type="checkbox"
                                    value="Pain Management" v-model="painmgt" id="int-2" disabled>
                                  ...
                                  <div class="form-check">
                                    <input class="form-check-input" type="checkbox"
                                    value="Insomnia/Eating Disorder" v-model="insomniaeating" id="int-3" disabled>
                                  ...
                                  <div class="form-check">
                                    <input class="form-check-input" type="checkbox"
                                    value="Learning/Development" v-model="learndevelop" id="int-4" disabled>
                                ...
                                <td>
                                  ...
                                  <div class="form-check">
                                    <input class="form-check-input" type="checkbox"
                                    value="Marital and Family Therapy" v-model="maritalfamily" id="int-5" disabled>
                                  ...
                                  <div class="form-check">
                                    <input class="form-check-input" type="checkbox"
                                    value="Stress and Anger Management" v-model="stressanger" id="int-6" disabled>
                                  ...
                                  <div class="form-check">
                                    <input class="form-check-input" type="checkbox"
                                    value="Addiction" v-model="addict" id="int-7" disabled>
                                  ...
                                  <div class="form-check">
                                    <input class="form-check-input" type="checkbox"
                                    value="Others" v-model="others2" id="int-8" disabled>
                                    <label class="form-check-label" for="8">
                                      Others
                                    </label>
                                  </div>
                                  <div id="Others-2">
                                    <input type="text" class="form-control" name="" placeholder="Please Specify" v-if="others2" disabled
                      ...
                      <tr>
                                      ...
                                      <td>
                                          <textarea class="form-control" placeholder="Enter Description" rows="15" v-model="case_formulation" disabled></textarea>
                                      </td>
                                  </tr>
                                  <tr>
            ...
            <div
              ...
              {{ catcode.icd_code }} {{catcode.icd_name}}
                          ...
                          <div class="row mb-3 align-items-flex-start">
                                                  ...
                                                  <div class="col-sm-8">
                                                      <select
                                                          id="additionalboxdiagnosis" v-model="additional_diagnosis" disabled
                          ...
                          <div class="clinical-work services hide mb-3">
                            <div class="row">
                              <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" v-model="code_id"  @change="onCategorycodebind($event)" disabled>
               ...
               {{ type.icd_category_code }} {{type.icd_category_name}}
                            ...
                            <div class="row">
                                                      <div class="col-md-6 mb-">
                                                          ...
                                                          <select class="form-select" v-model="additional_code_id"  @change="onCategorycodebindAdditional($event)" disabled>
                                                      ...
                                                      <div class="col-md-6 mb-3">
                                                              ...
                                                              <select id="additionalsubcodeicd" v-model="additional_sub_code_id" style="width:100%" class="form-select multiselectadditionalsubcode"  multiple="multiple" disabled>
