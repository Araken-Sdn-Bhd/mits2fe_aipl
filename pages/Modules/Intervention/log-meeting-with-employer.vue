            ...
            <div class="card-body">
              <form method="post" @submit.prevent="OnSubmit">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    <div class="mb-3">
                      ...
                      <textarea class="form-control textarea" v-model="purpose_of_meeting"></textarea>
                    </div>
                  </div>
                </div>
                <!-- close-row -->
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="mb-3">
                      <label class="form-label">Start Time of Discussion</label>
                      <input type="time" class="form-control" v-model="discussion_start_time" />
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="mb-3">
                      <label class="form-label">End Time of Discussion </label>
  ...
  methods: {
    ...
    async getdetails() {
      ...
      if (response.data.code == 200) {
        ...
        this.discussion_start_time =
          response.data.Data[0].discussion_start_time;
