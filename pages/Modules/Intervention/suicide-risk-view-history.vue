...
export default {
  ...
  beforeMount() {
    ...
    console.log("sr namesre", this.suicidalresult_history);
    if (this.suicidalresult_history) {
      this.test_name=this.suicidalresult_history.test_name;
      this.datetime=this.suicidalresult_history.datetime;
      this.result=this.suicidalresult_history.result;
      console.log("sr result", this.result);
    }
  },
  methods: {
    async Onsuciderisk() {
