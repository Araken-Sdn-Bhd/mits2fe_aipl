                                ...
                                <tr>
                                    <td colspan="2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="flexCheckDefault" v-model="consent_for_homevisit" />
                        ...
                        <table class="notes" v-if="consentdetails">
                            <tbody>
                                <tr>
                                    <td colspan="2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="flexCheckDefault1" v-model="consent_for_hereby_already_give_explanation" />
                        ...
                        <table class="notes table-padding">
                            <tbody>
                                <tr>
                                    <td colspan="2">
                                        <div class="form-check">
                                            <input v-if="consent_for_homevisit == true" class="form-check-input" type="checkbox" id="flexCheckDefault" checked />
                                            <input v-else class="form-check-input" type="checkbox" id="flexCheckDefault" value="false" />
                                            <label class="form-check-label" for="flexCheckDefault">
                                                I hereby agree and consent to receive treatment at
                                                home for me/as a guardian for psychiatry problem which
                                                have been explained to me by doctor. I understand
                        ...
                        <table class="notes" v-if="consentdetails">
                            <tbody>
                                <tr>
                                    <td colspan="2">
                                        <div class="form-check">
                                            <input v-if="consent_for_hereby_already_give_explanation == true" class="form-check-input" type="checkbox" id="flexCheckDefault1" checked />
                                            <input v-else class="form-check-input" type="checkbox" id="flexCheckDefault1" value="false" />
                                            <label class="form-check-label" for="flexCheckDefault1">
                                                I hereby already give explanation regarding community
                                                psychiatry services to the patient/guardian as above.
                                            </label>
            ...
            try {
                ...
                const response = await this.$axios.post(
                    "intervention/homevisit-form", {
                        ...
                        consent_for_hereby_already_give_explanation: this.consent_for_hereby_already_give_explanation,
                    }, {
                        headers
                    }
                );
