<template>
            ...
            <main>
                <div class="container-fluid px-4">
                    <div class="page-title">
                        <h1>LIST OF PREVIOUS OR CURRENT JOB</h1>
                        <!-- <a href="#"><i class="fal fa-plus"></i> Add</a> -->
                    </div>
                    <div class="card mb-4">
                        <div class="card-body new-form">
                            <div class="patient-info">
                                <table class="info-table" width="100%" v-if="patientdetails">
                                    <thead>
                                        <tr>
                                            <th width="40%"></th>
                                            <th width="60%"></th>
                            ...
                            <form method="post" @submit.prevent="OnSubmit">
                                <table class="job-search-table" id="joblist" v-if="!pid">
                                    <thead>
                                        <tr>
                                            <th>Job</th>
                                            <th>SALARY</th>
                                            <th>DURATION</th>
                                            <th>REASON FOR QUIT</th>
                                            <th></th>
                                        </tr>
                                    </thead>
                                ...
                                <table class="job-search-table" id="joblist1" v-if="pid">
                                    <thead>
                                        <tr>
                                            <th>Job</th>
                                            <th>SALARY</th>
                                    ...
                                    <tbody class="optionBox1">
                                        <tr class="block1" v-for="(job1,index) in jobSDESCRIPTION" :key="index">
                                            <td><input type="text" readonly class="form-control job" v-model="job1.job" /></td>
                                            <td><input type="text" readonly class="form-control salary" v-model="job1.salary" /></td>
                                            <td>
                                                <input type="text" readonly class="form-control duration" v-model="job1.duration" />
                                            </td>
                                            <td><input type="text" readonly  class="form-control reason" v-model="job1.reason_for_quit" /></td>
                                            <td>
                                            </td>
                                        </tr>
                                    </tbody>
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select class="form-select" disabled v-model="location_services_id">
                                                            <option value="0">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select class="form-select" disabled v-model="type_diagnosis_id">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="inlineRadioOptions" disabled id="inlineRadio1" value="assisstance" v-model="category_services" />
                                                            <label class="form-check-label" for="inlineRadio1">Assisstance / Supervision</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" disabled value="clinical-work" v-model="category_services" />
                                                            <label class="form-check-label" for="inlineRadio2">Clinical Work / Procedure
                                                            </label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio3" disabled value="external" v-model="category_services" />
                                                ...
                                                <div id="assisstance" class="assisstance services hide mb-3">
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <select class="form-select" disabled v-model="services_id">
                                                ...
                                                <div id="clinical-work" class="clinical-work services hide mb-3">
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <select class="form-select" disabled v-model="code_id" @change="onCategorycodebind($event)">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                                ...
                                                                <div class="mt-2 align-items-flex-start">
                                                                <select disabled id="additionalsubcodeicd" style="width:100%" class="form-select multiselectadditionalsubcode" v-model="additional_sub_code_id" multiple="multiple">
    ...
    export default {
        ...
        name: "list-of-previous-or-current-job-view",
        data() {
            return {
                userdetails: null,
                patientdetails: null,
            ...
            async OnSubmit() {
               ...
               var additionalboxdiagnosis = 0;
                ...
                $("table#joblist > tbody > tr").each(function (i) {
                    ...
                    obj.salary = $('td input[type="text"].salary', this).val();
                    obj.duration = $('td input[type="text"].duration', this).val();
                    obj.reason_for_quit = $('td input[type="text"].reason', this).val();
                ...
                try {
                    ...
                    if (
                        ...
                        const response = await this.$axios.post(
                            "previous-current-job/add", {
                                added_by: this.userdetails.user.id,
                                patient_id: this.Id,
                                jobrecord: jobSDESCRIPTION,
