                    ...
                    <td colspan="2">
                      <div class="form-check">
                        ...
                        <label
                          ...
                          for="flexCheckDefault"
                        >
                        I hereby agree to participate in supported <span style="text-transform: uppercase;color:#000;">Employment Transition Program (ETP)</span>  [{{ consentdetails.hospital_branch_name }}]. I also agree to follow the rules and give my full commitment. I fully understand if any rules was not follow, I deemed to be terminated from this program.
  ...
  methods: {
    async GetPatientConnsentdetails() {
      ...
      if (response.data.code == 200) {
        ...
        this.designation = this.consentdetails.designation;
