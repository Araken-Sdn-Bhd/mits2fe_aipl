                            ...
                            <tr>
                              <td class="other-input1">
                                <div class="form-check">
                                  <input class="form-check-input" value="Twice A Week" v-model="frequency_session"
                                    type="radio" name="frequency-of-session" id="1">
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" value="Once A Week" v-model="frequency_session"
                                    type="radio" name="frequency-of-session" id="2">
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" value="Once In Two  Week" v-model="frequency_session"
                                    type="radio" name="frequency-of-session" id="3">
                                  <label class="form-check-label" for="3">
                                    Once In Two Weeks
                                  </label>
                                </div>
                                <div class="form-check">
                                  <input class="form-check-input" value="Once A Month" v-model="frequency_session"
                                    type="radio" name="frequency-of-session" id="4">
                                  <label class="form-check-label" for="4">
                                    Once A Month
                                  </label>
                                </div>
                                <div class="form-check">
                                  <input class="form-check-input" v-model="frequency_session" type="radio"
                                    name="frequency-of-session" id="5" value="therapy-1">
                                  <label class="form-check-label" for="5">
                                    Others
                                  </label>
                                </div>
                                <div class="therapy-1 hide others1">
                                  <input type="text" v-model="frequency_session_other" class="form-control" name=""
                              ...
                              <td class="other-input2">
                                <div class="form-check">
                                  <input class="form-check-input" value="Psychodynamic" v-model="model_therapy"
                                    type="radio" name="mode-Of-therapy" id="6">
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" value="Cognitive" v-model="model_therapy" type="radio"
                                    name="mode-Of-therapy" id="7">
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" value="Behavioral" v-model="model_therapy"
                                    type="radio" name="mode-Of-therapy" id="8">
                                  <label class="form-check-label" for="8">
                                    Behavioral
                                  </label>
                                </div>
                                <div class="form-check">
                                  <input class="form-check-input" value="Systemic" v-model="model_therapy" type="radio"
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" value="Supportive" v-model="model_therapy"
                                    type="radio" name="mode-Of-therapy" id="10">
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" value="Eclectic" v-model="model_therapy" type="radio"
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" v-model="model_therapy" type="radio"
                                    name="mode-Of-therapy" id="12" value="therapy-2">
                                  <label class="form-check-label" for="12">
                                    Others
                                  </label>
                                </div>
                                <div class="therapy-2 hide others2">
                                  <input type="text" v-model="model_therapy_other" class="form-control" name=""
                                    placeholder="Please Specify">
                                </div>
                              </td>
                              <td class="other-input3">
                                <div class="form-check">
                                  <input class="form-check-input" value="Individual" v-model="mode_therapy" type="radio"
                                    name="mode-Of-therapy1" id="1.1">
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" value="Group" v-model="mode_therapy" type="radio"
                                    name="mode-Of-therapy1" id="1.2">
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" value="Couple/Marital" v-model="mode_therapy"
                                    type="radio" name="mode-Of-therapy1" id="1.3">
                                  <label class="form-check-label" for="1.3">
                                    Couple/Marital
                                  </label>
                                </div>
                                <div class="form-check">
                                  <input class="form-check-input" value="Family" v-model="mode_therapy" type="radio"
                                    name="mode-Of-therapy1" id="1.4">
                                  <label class="form-check-label" for="1.4">
                                    Family
                                  </label>
                                </div>
                                <div class="form-check">
                                  <input class="form-check-input" v-model="mode_therapy" type="radio"
                                    name="mode-Of-therapy1" id="1.5" value="therapy-3">
                                  <label class="form-check-label" for="1.5">
                                    Others
                                  </label>
                                </div>
                                <div class="therapy-3 hide others3">
                                  <input type="text" class="form-control" v-model="mode_therapy_other" name=""
                                    placeholder="Please Specify">
                                </div>
                              </td>
                            </tr>
                          ...
                          <tbody>
                            <tr>
                              <td>
                                ...
                                <textarea class="form-control textarea" v-model="comment_therapy_session"
                          ...
                          <tbody>
                            <tr>
                              <td class=" other-input">
                                <div class="form-check">
                                  <input class="form-check-input" value="Improved" v-model="patent_condition"
                                    type="radio" name="condition" id="4.1">
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" value="Unchanged" v-model="patent_condition"
                                    type="radio" name="condition" id="4.2">
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" value="Worsened" v-model="patent_condition"
                                    type="radio" name="condition" id="4.3">
                                  <label class="form-check-label" for="4.3">
                                    Worsened
                                  </label>
                                </div>
                                <div class="form-check">
                                  <input class="form-check-input" v-model="patent_condition" type="radio"
                                    name="condition" id="4.5" value="condition-others">
                                  <label class="form-check-label" for="4.5">
                                    Others
                                  </label>
                                </div>
                                <div class="condition-others hide others">
                                  <input type="text" v-model="patent_condition_other" class="form-control" name=""
                                    placeholder="Please Specify">
                                </div>
                              </td>
                            </tr>
                          ...
                          <tbody>
                            <tr>
                              <td>
                                ...
                                <textarea class="form-control textarea" v-model="comment_patent_condition"
                                  placeholder="Enter Comments"></textarea>
                              </td>
                            </tr>
                          </tbody>
