...
export default {
    ...
    methods: {
        ...
        async GetList() {
            ...
            const response11 = await this.$axios.get("diagnosis/getIcd9codeList", {
                headers,
            });
            if (response6.data.code == 200 || response11.data.code == "200") {
                this.additionalcodelist = response11.data.list;
            } else {
