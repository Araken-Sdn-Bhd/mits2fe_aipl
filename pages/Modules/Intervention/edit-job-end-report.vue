          ...
          add_sub_code_id = this.value;
            ...
            async getdetails() {
                ...
                if (response.data.code == 200) {
                    ...
                    this.changes_in_job_duties = response.data.Data[0].changes_in_job_duties;
                    ...
                    this.staff_comments_regarding_job = response.data.Data[0].staff_comments_regarding_job;
                    this.employer_comments = response.data.Data[0].employer_comments;
                    this.type_of_support = response.data.Data[0].type_of_support;
                    this.person_wish_for_another_job = response.data.Data[0].person_wish_for_another_job;
