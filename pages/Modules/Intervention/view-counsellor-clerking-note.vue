                              ...
                              <table class="notes">
                                  ...
                                  <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td><textarea disabled v-model="clinical_summary" class="form-control" rows="15" placeholder="Enter Description"></textarea></td>
                                    </tr>
                                    <tr>
                                        <th>Background History<small style="color:red">*</small> :</th>
                                        <td><textarea disabled v-model="background_history" class="form-control" rows="15" placeholder="Enter Description"></textarea></td>
                                    </tr>
                                    <tr>
                                        <th>Clinical Notes<small style="color:red">*</small> :</th>
                                        <td><textarea disabled v-model="clinical_notes" class="form-control" rows="15" placeholder="Enter Description"></textarea></td>
                                    </tr>
                                    <tr>
                                        <th>Management<small style="color:red">*</small> :</th>
                                        <td><textarea disabled v-model="management" class="form-control" rows="15" placeholder="Enter Description"></textarea></td>
                                    </tr>
                                  </tbody>
                              </table>
