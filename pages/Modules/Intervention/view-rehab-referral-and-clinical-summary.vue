                ...
                <table class="notes notes-sub">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <select disabled class="form-select" v-model="education_level" :disabled = "isDisabled">
                          <option value="">Please Select</option>
                          <option
                    ...
                    <tr>
                      ...
                      <td>
                        <input disabled type="text" class="form-control" name="" v-model="age_first_started" :disabled = "isDisabled"/>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="2">
                          ...
                          <div class="assisstance services hide mb-3">
                            <div class="row">
                              <div class="col-md-6 mb-3">
                                ...
                                <select disabled class="form-select" v-model="services_id" :disabled = "isDisabled">
                    ...
                    >
                      <div class="accordion-body">
                        <div class="col-md-12 mb-3">
                          ...
                          <textarea disabled v-model="medication_prescription"
                            class="form-control textarea"
