                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-6 mb-3">
                                    <div class="">
                                        ...
                                        <select class="form-select" v-model="job_club" disabled>
                                            <option value="">Please Select Job Club</option>
                                            <option v-for="jb in joblist" v-bind:key="jb.id" v-bind:value="jb.id">
                                                {{ jb.club_name }}
                                            </option>
                                        </select>
                                    </div>
