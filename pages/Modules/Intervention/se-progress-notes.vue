                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <textarea class="form-control textarea" rows="5" v-model="progress_note"></textarea>
                                </div>
                            </div>
                            <!-- close-row -->
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <textarea class="form-control textarea" rows="5" v-model="management_plan"></textarea>
                                </div>
                            </div>
                            <!-- close-row -->
