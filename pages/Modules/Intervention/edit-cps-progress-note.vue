                  ...
                  <tbody>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate"
                                    id="heroin-opiate-Nil" value="Nil" v-model="delusions" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate"
                                    id="heroin-opiate-previous-history" value="Mild" v-model="delusions" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate"
                                    id="heroin-opiate-current-use" value="Moderate" v-model="delusions" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate"
                                    id="heroin-opiate-current-use serve" value="Severe" v-model="delusions" />
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate1"
                                    id="heroin-opiate-Nil1" value="Nil" v-model="hallucination" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate1"
                                    id="heroin-opiate-previous-history1" value="Mild" v-model="hallucination" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate1"
                                    id="heroin-opiate-current-use1" value="Moderate" v-model="hallucination" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate1"
                                    id="heroin-opiate-current-use s1" value="Severe" v-model="hallucination" />
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate2"
                                    id="heroin-opiate-Nil2" value="Nil" v-model="behavior" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate2"
                                    id="heroin-opiate-previous-history2" value="Mild" v-model="behavior" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate2"
                                    id="heroin-opiate-current-use2" value="Moderate" v-model="behavior" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate2"
                                    id="heroin-opiate-current-use s2" value="Severe" v-model="behavior" />
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate3"
                                    id="heroin-opiate-Nil3" value="Nil" v-model="blunted_affect" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate3"
                                    id="heroin-opiate-previous-history3" value="Mild" v-model="blunted_affect" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate3"
                                    id="heroin-opiate-current-use3" value="Moderate" v-model="blunted_affect" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate3"
                                    id="heroin-opiate-current-use s3" value="Severe" v-model="blunted_affect" />
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate4"
                                    id="heroin-opiate-Nil4" value="Nil" v-model="depression" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate4"
                                    id="heroin-opiate-previous-history4" value="Mild" v-model="depression" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate4"
                                    id="heroin-opiate-current-use4" value="Moderate" v-model="depression" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate4"
                                    id="heroin-opiate-current-use s4" value="Severe" v-model="depression" />
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate5"
                                    id="heroin-opiate-Nil5" value="Nil" v-model="anxiety" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate5"
                                    id="heroin-opiate-previous-history5" value="Mild" v-model="anxiety" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate5"
                                    id="heroin-opiate-current-use5" value="Moderate" v-model="anxiety" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate5"
                                    id="heroin-opiate-current-use s5" value="Severe" v-model="anxiety" />
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate6"
                                    id="heroin-opiate-Nil6" value="Nil" v-model="disorientation" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate6"
                                    id="heroin-opiate-previous-history6" value="Mild" v-model="disorientation" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate6"
                                    id="heroin-opiate-current-use6" value="Moderate" v-model="disorientation" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate6"
                                    id="heroin-opiate-current-use s6" value="Severe" v-model="disorientation" />
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate7"
                                    id="heroin-opiate-Nil7" value="Nil" v-model="uncooperativeness" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate7"
                                    id="heroin-opiate-previous-history7" value="Mild" v-model="uncooperativeness" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate7"
                                    id="heroin-opiate-current-use7" value="Moderate" v-model="uncooperativeness" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate7"
                                    id="heroin-opiate-current-use s7" value="Severe" v-model="uncooperativeness" />
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate8"
                                    id="heroin-opiate-Nil8" value="Nil" v-model="poor_impulse_control" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate8"
                                    id="heroin-opiate-previous-history8" value="Mild" v-model="poor_impulse_control" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate8"
                                    id="heroin-opiate-current-use8" value="Moderate" v-model="poor_impulse_control" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate8"
                                    id="heroin-opiate-current-use s8" value="Severe" v-model="poor_impulse_control" />
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate9"
                                    id="heroin-opiate-Nil9" value="Nil" v-model="others" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate9"
                                    id="heroin-opiate-previous-history9" value="Mild" v-model="others" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate9"
                                    id="heroin-opiate-current-use9" value="Moderate" v-model="others" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="heroin-opiate9"
                                    id="heroin-opiate-current-use s9" value="Severe" v-model="others" />
                        ...
                        <table class="sub-table-form td-width">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="Aggresion" id="aggresion-none"
                                    value="No" v-model="risk_of_violence" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="Aggresion" id="aggresion-low"
                                    value="Low" v-model="risk_of_violence" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="Aggresion" id="aggresion-medium"
                                    value="Moderate" v-model="risk_of_violence" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="Aggresion" id="aggresion-high"
                                    value="High" v-model="risk_of_violence" />
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="Aggresion1" id="aggresion-none1"
                                    value="No" v-model="risk_of_suicide" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="Aggresion1" id="aggresion-low1"
                                    value="Low" v-model="risk_of_suicide" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="Aggresion1" id="aggresion-medium1"
                                    value="Moderate" v-model="risk_of_suicide" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="Aggresion1" id="aggresion-high1"
                                    value="High" v-model="risk_of_suicide" />
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="Aggresion2" id="aggresion-none2"
                                    value="No" v-model="risk_of_other_deliberate" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="Aggresion2" id="aggresion-low2"
                                    value="Low" v-model="risk_of_other_deliberate" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="Aggresion2" id="aggresion-medium2"
                                    value="Moderate" v-model="risk_of_other_deliberate" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="Aggresion2" id="aggresion-high2"
                                    value="High" v-model="risk_of_other_deliberate" />
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="Aggresion3" id="aggresion-none3"
                                    value="No" v-model="risk_of_severe" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="Aggresion3" id="aggresion-low3"
                                    value="Low" v-model="risk_of_severe" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="Aggresion3" id="aggresion-medium3"
                                    value="Moderate" v-model="risk_of_severe" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="Aggresion3" id="aggresion-high3"
                                    value="High" v-model="risk_of_severe" />
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="Aggresion4" id="aggresion-low4"
                                    value="Low" v-model="risk_of_harm" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="Aggresion4" id="aggresion-medium4"
                                    value="Moderate" v-model="risk_of_harm" />
                              ...
                              <td>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="Aggresion4" id="aggresion-high4"
                                    value="High" v-model="risk_of_harm" />
                      ...
                      <td>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="Akathisia" id="Akathisia-none"
                            value="Absent" v-model="akathisia" />
                        ...
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="Akathisia" id="Akathisia-low"
                            value="Present" v-model="akathisia" />
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="Acute" id="Acute-low" value="Present"
                            v-model="acute_dystonia" />
                      ...
                      <td>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="Parkinsonism" id="Parkinsonism-none"
                            value="Absent" v-model="parkinsonism" />
                        ...
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="Parkinsonism" id="Parkinsonism-low"
                            value="Present" v-model="parkinsonism" />
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="Tardive" id="Tardive-low" value="Present"
                            v-model="tardive_dyskinesia" />
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="Dystonia" id="Dystonia-low" value="Present"
                            v-model="tardive_dystonia" />
                      ...
                      <td>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="Psychoeducation" id="Psychoeducation-none"
                            value="Yes" v-model="psychoeducation" />
                        ...
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="Psychoeducation" id="Psychoeducation-low"
                            value="No" v-model="psychoeducation" />
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="Coping" id="Coping-low" value="No"
                            v-model="coping_skills" />
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="ADL" id="ADL-low" value="No"
                            v-model="adl_training" />
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="Supported" id="Supported-low" value="No"
                            v-model="supported_employment" />
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="Family" id="Family-low" value="No"
                            v-model="family_intervention" />
                      ...
                      <td colspan="3">
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="Employment" id="Employment-none"
                            value="Yes" v-model="employment_past_months" />
                        ...
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="Employment" id="Employment-low" value="No"
