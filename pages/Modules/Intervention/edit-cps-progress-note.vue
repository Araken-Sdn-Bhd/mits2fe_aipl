                                        ...
                                        <tr class="three-td">
                                            ...
                                            <td class="tdl-5">
                                                <select class="form-select" aria-label="Default select example"
                                                    ...
                                                    <option v-for="team in stafflist" v-bind:key="team.id"
                                        ...
                                        <tr class="three-td">
                                            ...
                                            <td class="tdl-5">
                                                <select class="form-select" aria-label="Default select example"
                                                    ...
                                                    <option value="">Please Select</option>
                                                    <option v-for="role in rolelist" v-bind:key="role.id"
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                ></a> -->
                                        ...
                                        <tr class="two-td">
                                            ...
                                            <td colspan="3">
                                                <select class="form-select" aria-label="Default select example"
                                                    ...
                                                    <option value="">Please Select</option>
                                                    <option v-for="stf in stafflist" v-bind:key="stf.id"
                                                        v-bind:value="stf.id">
                                                        {{ stf.name }}
                                                    </option>
                                                </select>
                                        ...
                                        <tr class="two-td">
                                            ...
                                            <td colspan="3">
                                                <select class="form-select" aria-label="Default select example"
                                                    ...
                                                    <option value="">Please Select</option>
                                                    <option v-for="out in outcomelist" v-bind:key="out.id"
                                                        v-bind:value="out.id">
                                                        {{ out.section_value }}
                                                    </option>
                                                </select>
                                        ...
                                        <tr class="two-td">
                                            ...
                                            <td colspan="3">
                                                <select class="form-select" v-model="current_intervention">
                                                    <option value="">Please Select</option>
                                                    <option v-for="crt in currentinterventionlist" v-bind:key="crt.id"
                                                        v-bind:value="crt.id">
                                                        {{ crt.section_value }}
                                                    </option>
                                                </select>
                                        ...
                                        <tr class="two-td">
                                            ...
                                            <td colspan="3">
                                                <select class="form-select" v-model="compliance_treatment">
                                                    <option value="">Please Select</option>
                                                    <option v-for="com in compliancetotreatment" v-bind:key="com.id"
                                                        v-bind:value="com.id">
                                                        {{ com.section_value }}
                                                    </option>
                                                </select>
                                        ...
                                        <tr class="two-td">
                                            ...
                                            <td colspan="2">
                                                <select class="form-select" v-model="medication_supervised_by">
                                                    <option value="">Please Select</option>
                                                    <option v-for="med in medicationsupervised" v-bind:key="med.id"
                                                        v-bind:value="med.id">
                                                        {{ med.section_value }}
                                                    </option>
                                                </select>
                                            ...
                                            <td colspan="2">
                                                <input v-model="medication_supervised_by_specify" type="text"
                                                    class="form-control" v-if="medication_supervised_by == '263'"
                                                    placeholder="Specify" />
                                            </td>
                                        </tr>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate" id="heroin-opiate-Nil"
                                                                        value="Nil" v-model="delusions" />
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate"
                                                                        id="heroin-opiate-previous-history" value="Mild"
                                                                        v-model="delusions" />
                                                                    <label class="form-check-label"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate"
                                                                        id="heroin-opiate-current-use" value="Moderate"
                                                                        v-model="delusions" />
                                                                    <label class="form-check-label"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        ...
                                                                        value="Severe" v-model="delusions" />
                                                                    <label class="form-check-label"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate1" id="heroin-opiate-Nil1"
                                                                        value="Nil" v-model="hallucination" />
                                                                    <label class="form-check-label"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        ...
                                                                        value="Mild" v-model="hallucination" />
                                                                    <label class="form-check-label"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate1"
                                                                        id="heroin-opiate-current-use1" value="Moderate"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate1"
                                                                        id="heroin-opiate-current-use s1" value="Severe"
                                                                        v-model="hallucination" />
                                                                    <label class="form-check-label"
                                                        ...
                                                        <tr>
                                                            <th>Disorganized Speech /Behavior<small
                                                                    style="color:red">*</small></th>
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate2" id="heroin-opiate-Nil2"
                                                                        value="Nil" v-model="behavior" />
                                                                    <label class="form-check-label"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate2"
                                                                        id="heroin-opiate-current-use2" value="Moderate"
                                                                        v-model="behavior" />
                                                                    <label class="form-check-label"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate2"
                                                                        id="heroin-opiate-current-use s2" value="Severe"
                                                                        v-model="behavior" />
                                                                    <label class="form-check-label"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate3" id="heroin-opiate-Nil3"
                                                                        value="Nil" v-model="blunted_affect" />
                                                                    <label class="form-check-label"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        ...
                                                                        value="Mild" v-model="blunted_affect" />
                                                                    <label class="form-check-label"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate3"
                                                                        id="heroin-opiate-current-use3" value="Moderate"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate3"
                                                                        id="heroin-opiate-current-use s3" value="Severe"
                                                                        v-model="blunted_affect" />
                                                                    <label class="form-check-label"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate4" id="heroin-opiate-Nil4"
                                                                        value="Nil" v-model="depression" />
                                                                    <label class="form-check-label"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate4"
                                                                        id="heroin-opiate-current-use4" value="Moderate"
                                                                        v-model="depression" />
                                                                    <label class="form-check-label"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate4"
                                                                        id="heroin-opiate-current-use s4" value="Severe"
                                                                        v-model="depression" />
                                                                    <label class="form-check-label"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate5" id="heroin-opiate-Nil5"
                                                                        value="Nil" v-model="anxiety" />
                                                                    <label class="form-check-label"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate5"
                                                                        id="heroin-opiate-current-use5" value="Moderate"
                                                                        v-model="anxiety" />
                                                                    <label class="form-check-label"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate5"
                                                                        id="heroin-opiate-current-use s5" value="Severe"
                                                                        v-model="anxiety" />
                                                                    <label class="form-check-label"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate6" id="heroin-opiate-Nil6"
                                                                        value="Nil" v-model="disorientation" />
                                                                    <label class="form-check-label"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        ...
                                                                        value="Mild" v-model="disorientation" />
                                                                    <label class="form-check-label"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate6"
                                                                        id="heroin-opiate-current-use6" value="Moderate"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate6"
                                                                        id="heroin-opiate-current-use s6" value="Severe"
                                                                        v-model="disorientation" />
                                                                    <label class="form-check-label"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate7" id="heroin-opiate-Nil7"
                                                                        value="Nil" v-model="uncooperativeness" />
                                                                    <label class="form-check-label"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        ...
                                                                        value="Mild" v-model="uncooperativeness" />
                                                                    <label class="form-check-label"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate7"
                                                                        id="heroin-opiate-current-use7" value="Moderate"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate7"
                                                                        id="heroin-opiate-current-use s7" value="Severe"
                                                                        v-model="uncooperativeness" />
                                                                    <label class="form-check-label"
                                                        ...
                                                        <tr>
                                                            <th>Poor Impulse Control<small style="color:red">*</small>
                                                            </th>
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate8" id="heroin-opiate-Nil8"
                                                                        value="Nil" v-model="poor_impulse_control" />
                                                                    <label class="form-check-label"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        ...
                                                                        value="Mild" v-model="poor_impulse_control" />
                                                                    <label class="form-check-label"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate8"
                                                                        id="heroin-opiate-current-use8" value="Moderate"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate8"
                                                                        id="heroin-opiate-current-use s8" value="Severe"
                                                                        v-model="poor_impulse_control" />
                                                                    <label class="form-check-label"
                                                        ...
                                                        <tr>
                                                            <th>Others, Please specify<small style="color:red">*</small>
                                                            </th>
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate9" id="heroin-opiate-Nil9"
                                                                        value="Nil" v-model="others" />
                                                                    <label class="form-check-label"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate9"
                                                                        id="heroin-opiate-current-use9" value="Moderate"
                                                                        v-model="others" />
                                                                    <label class="form-check-label"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="heroin-opiate9"
                                                                        id="heroin-opiate-current-use s9" value="Severe"
                                                                        v-model="others" />
                                                                    <label class="form-check-label"
                                            ...
                                            <td colspan="4">
                                                <table class="sub-table-form td-width mental-state">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <th>Risk of violence/harm to others<small
                                                                    style="color:red">*</small></th>
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="Aggresion" id="aggresion-none" value="No"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="Aggresion" id="aggresion-low" value="Low"
                                                                        v-model="risk_of_violence" />
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="Aggresion" id="aggresion-medium"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="Aggresion" id="aggresion-high"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="Aggresion1" id="aggresion-none1"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="Aggresion1" id="aggresion-low1"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="Aggresion1" id="aggresion-medium1"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="Aggresion1" id="aggresion-high1"
                                                        ...
                                                        <tr>
                                                            <th>Risk Of Other Deliberate Self Harm<small
                                                                    style="color:red">*</small></th>
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="Aggresion2" id="aggresion-none2"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="Aggresion2" id="aggresion-low2"
                                                                        value="Low"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="Aggresion2" id="aggresion-medium2"
                                                                        value="Moderate"
                                                                        v-model="risk_of_other_deliberate" />
                                                                    <label class="form-check-label"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="Aggresion2" id="aggresion-high2"
                                                                        value="High"
                                                                        v-model="risk_of_other_deliberate" />
                                                                    <label class="form-check-label"
                                                                        for="aggresion-high2">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="Aggresion3" id="aggresion-none3"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="Aggresion3" id="aggresion-low3"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="Aggresion3" id="aggresion-medium3"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="Aggresion3" id="aggresion-high3"
                                                        ...
                                                        <tr>
                                                            <th>Risk Of Harm From Others / Vulnerability<small
                                                                    style="color:red">*</small></th>
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="Aggresion4" id="aggresion-none4"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="Aggresion4" id="aggresion-low4"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="Aggresion4" id="aggresion-medium4"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="Aggresion4" id="aggresion-high4"
                                        ...
                                        <tr class="two-td">
                                            <th>Changes in treatment at Current Visit<small style="color:red">*</small>
                                                :</th>
                                            <td colspan="3">
                                                <textarea class="form-control textarea"
                                                    v-model="changes_in_teratment"></textarea>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="two-radio">
                                            ...
                                            <td>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="Akathisia"
                                                        id="Akathisia-none" value="Absent" v-model="akathisia" />
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="Akathisia"
                                                        id="Akathisia-low" value="Present" v-model="akathisia" />
                                        ...
                                        <tr class="two-radio">
                                            ...
                                            <td>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="Acute"
                                                        id="Acute-none" value="Absent" v-model="acute_dystonia" />
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="Acute"
                                                        id="Acute-low" value="Present" v-model="acute_dystonia" />
                                        ...
                                        <tr class="two-radio">
                                            ...
                                            <td>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="Parkinsonism"
                                                        id="Parkinsonism-none" value="Absent" v-model="parkinsonism" />
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="Parkinsonism"
                                                        id="Parkinsonism-low" value="Present" v-model="parkinsonism" />
                                        ...
                                        <tr class="two-radio">
                                            ...
                                            <td>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="Tardive"
                                                        id="Tardive-none" value="Absent" v-model="tardive_dyskinesia" />
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="Tardive"
                                                        id="Tardive-low" value="Present" v-model="tardive_dyskinesia" />
                                        ...
                                        <tr class="two-radio">
                                            ...
                                            <td>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="Dystonia"
                                                        id="Dystonia-none" value="Absent" v-model="tardive_dystonia" />
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="Dystonia"
                                                        id="Dystonia-low" value="Present" v-model="tardive_dystonia" />
                                        ...
                                        <tr>
                                            <td colspan="4" class="black">
                                                Personal And Social Performance (PSP) Scale<small
                                        ...
                                        <tr class="psp-scale">
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-warning btn-text ml-10"
                                                    @click="Openpsptest">
                                        ...
                                        <tr class="two-radio">
                                            ...
                                            <td>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="Psychoeducation"
                                                        id="Psychoeducation-none" value="Yes"
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="Psychoeducation"
                                                        id="Psychoeducation-low" value="No" v-model="psychoeducation" />
                                        ...
                                        <tr class="two-radio">
                                            ...
                                            <td>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="Coping"
                                                        id="Coping-none" value="Yes" v-model="coping_skills" />
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="Coping"
                                                        id="Coping-low" value="No" v-model="coping_skills" />
                                        ...
                                        <tr class="two-radio">
                                            ...
                                            <td>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="ADL"
                                                        id="ADL-none" value="Yes" v-model="adl_training" />
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="ADL" id="ADL-low"
                                                        value="No" v-model="adl_training" />
                                        ...
                                        <tr class="two-radio">
                                            ...
                                            <td>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="Supported"
                                                        id="Supported-none" value="Yes"
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="Supported"
                                                        id="Supported-low" value="No" v-model="supported_employment" />
                                        ...
                                        <tr class="two-radio">
                                            ...
                                            <td>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="Family"
                                                        id="Family-none" value="Yes" v-model="family_intervention" />
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="Family"
                                                        id="Family-low" value="No" v-model="family_intervention" />
                                        ...
                                        <tr class="two-radio">
                                            ...
                                            <td colspan="3">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="Employment"
                                                        id="Employment-none" value="Yes"
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select class="form-select" v-model="location_services_id">
                                                            <option value="0">
                                                                Select location of services<small
                                                                    style="color:red">*</small>
                                                            </option>
                                                            <option v-for="loc in locationlist" v-bind:key="loc.id"
                                                                v-bind:value="loc.id">
                                                                {{ loc.section_value }}
                                                            </option>
                                                        </select>
                                                ...
                                                <!-- close-row -->
                                                <div class="row mb-3">
                                                    <label class="col-sm-4 col-form-label">Type Of Diagnosis<small
                                                            style="color:red">*</small></label>
                                                    <div class="col-sm-8">
                                                        <select class="form-select" v-model="type_diagnosis_id">
                                                            <option value="0">Select Diagnosis</option>
                                                            <option v-for="catcode in diagonisislist"
                                            ...
                                            <!-- close row -->
                                                <div class="row mb-3">
                                                    <label class="col-lg-4 col-sm-12 col-form-label">Category Of
                                                        Services<small style="color:red">*</small>
                                                    </label>
                                                    <div class="col-lg-8 col-sm-12">
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <label class="form-check-label"
                                                                for="inlineRadio1">Assisstance / Supervision</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                name="inlineRadioOptions1" id="inlineRadio2"
                                                                value="clinical-work" v-model="category_services" />
                                                            <label class="form-check-label" for="inlineRadio2">Clinical
                                                                Work / Procedure
                                                            </label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                name="inlineRadioOptions2" id="inlineRadio3"
                                                                value="external" v-model="category_services" />
                                                            <label class="form-check-label"
                                                                for="inlineRadio3">External</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- close-row -->
                                                ...
                                                <div class="assisstance services hide mb-3">
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            <label class="form-label">Services<small
                                                                    style="color:red">*</small></label>
                                                            <select class="form-select" v-model="services_id">
                                                                <option value="0">Select Service</option>
                                                                <option v-for="slt in assistancelist"
                                                                    v-bind:key="slt.id" v-bind:value="slt.id">
                                                                    {{ slt.section_value }}
                                                                </option>
                                                            </select>
                                                        </div>
                                                ...
                                                <div class="clinical-work services hide mb-3">
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            <label class="form-label">ICD 9 CODE<small
                                                                    style="color:red">*</small></label>
                                                            <select class="form-select" v-model="code_id"
                                                                @change="onCategorycodebind($event)">
                                                                <option value="0">Select code</option>
                                                                <option v-for="type in codelist" v-bind:key="type.id"
                                                                    v-bind:value="type.id">
                                                                    {{ type.icd_category_code }} {{
                                                                            type.icd_category_name
                                                                    }}
                                                                </option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <select class="form-select" v-model="serviceid">
                                                                <option value="0">Select Service</option>
                                                                <option v-for="slt in externallist" v-bind:key="slt.id"
                                                                    v-bind:value="slt.id">
                                                                    {{ slt.section_value }}
                                                                </option>
                                                            </select>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        <label class="form-label">Complexity Of Service<small
                                                                style="color:red">*</small></label>
                                                        <select class="form-select" v-model="complexity_services_id">
                                                            <option value="0">
                                                                Select Complexity Of Service
                                                            </option>
                                                            <option v-for="cm in comlexcitylist" v-bind:key="cm.id"
                                                                v-bind:value="cm.id">
                                                                {{ cm.section_value }}
                                                            </option>
                                                        </select>
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        <label class="form-label">Outcome<small
                                                                style="color:red">*</small></label>
                                ...
                                <div class="accordion form-accordion mt-3" id="accordionExample">
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                <div class="row mb-3">
                                                    <label class="col-sm-4 col-form-label">Location Of Services :
                                                    </label>
                                                    <div class="col-sm-8">
                                                ...
                                                <div class="clinical-work services hide mb-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            {{ this.sub_codeIdSectionValue.icd_code }} {{
                                                                    this.sub_codeIdSectionValue.icd_name
                                                            }}
                                                        </div>
                                                    </div>
                                                </div>
