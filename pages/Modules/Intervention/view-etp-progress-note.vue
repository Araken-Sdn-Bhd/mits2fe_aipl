                  ...
                  <div class="card mb-4">
                      <div class="card-body">
                          <div>
                              ...
                              <!-- close-row -->
                              <div class="row mb-3">
                                  <label class="col-sm-4 col-form-label">Work Readiness<small style="color:red">*</small> </label>
                                  <div class="col-sm-8">
                                      <div class="form-check form-check-inline">
                                          <input disabled class="form-check-input" type="radio" id="inlineCheckbox1" value="Yes" name="inlineRadioOptions1" v-model="work_readiness" />
                                          <label class="form-check-label" for="inlineCheckbox1">Yes</label>
                                      </div>
                                      <div class="form-check form-check-inline">
                                          <input disabled class="form-check-input" type="radio" id="inlineCheckbox2" value="No" name="inlineRadioOptions1" v-model="work_readiness" />
