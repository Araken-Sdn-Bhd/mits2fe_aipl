                            ...
                            <table class="form-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="1" value="" name="question1" @change="onprecontemplation(1, 1)" />
                                                <label class="form-check-label" for="1">1</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="2" value="" name="question1" @change="onprecontemplation(1, 2)" />
                                                <label class="form-check-label" for="2">2</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="3" value="" name="question1" @change="onprecontemplation(1, 3)" />
                                                <label class="form-check-label" for="3">3</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="4" value="" name="question1" @change="onprecontemplation(1, 4)" />
                                                <label class="form-check-label" for="4">4</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="5" value="" name="question1" @change="onprecontemplation(1, 5)" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="2.1" value="" name="question2" @change="onprecontemplation(2, 1)" />
                                                <label class="form-check-label" for="2.1">1</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="2.2" value="" name="question2" @change="onprecontemplation(2, 2)" />
                                                <label class="form-check-label" for="2.2">2</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="2.3" value="" name="question2" @change="onprecontemplation(2, 3)" />
                                                <label class="form-check-label" for="2.3">3</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="2.4" value="" name="question2" @change="onprecontemplation(2, 4)" />
                                                <label class="form-check-label" for="2.4">4</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="2.5" value="" name="question2" @change="onprecontemplation(2, 5)" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="3.1" value="" name="question3" @change="onprecontemplation(3, 1)" />
                                                <label class="form-check-label" for="3.1">1</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="3.2" value="" name="question3" @change="onprecontemplation(3, 2)" />
                                                <label class="form-check-label" for="3.2">2</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="3.3" value="" name="question3" @change="onprecontemplation(3, 3)" />
                                                <label class="form-check-label" for="3.3">3</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="3.4" value="" name="question3" @change="onprecontemplation(3, 4)" />
                                                <label class="form-check-label" for="3.4">4</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="3.5" value="" name="question3" @change="onprecontemplation(3, 5)" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="4.1" value="" name="question4" @change="onprecontemplation(4, 1)" />
                                                <label class="form-check-label" for="4.1">1</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="4.2" value="" name="question4" @change="onprecontemplation(4, 2)" />
                                                <label class="form-check-label" for="4.2">2</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="4.3" value="" name="question4" @change="onprecontemplation(4, 3)" />
                                                <label class="form-check-label" for="4.3">3</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="4.4" value="" name="question4" @change="onprecontemplation(4, 4)" />
                                                <label class="form-check-label" for="4.4">4</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="4.5" value="" name="question4" @change="onprecontemplation(4, 5)" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="5.1" value="" name="question5" @change="onprecontemplation(5, 1)" />
                                                <label class="form-check-label" for="5.1">1</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="5.2" value="" name="question5" @change="onprecontemplation(5, 2)" />
                                                <label class="form-check-label" for="5.2">2</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="5.3" value="" name="question5" @change="onprecontemplation(5, 3)" />
                                                <label class="form-check-label" for="5.3">3</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="5.4" value="" name="question5" @change="onprecontemplation(5, 4)" />
                                                <label class="form-check-label" for="5.4">4</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="5.5" value="" name="question5" @change="onprecontemplation(5, 5)" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="6.1" value="" @change="onprecontemplation(6, 1)" />
                                                <label class="form-check-label" for="6.1">1</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="6.2" value="" @change="onprecontemplation(6, 2)" />
                                                <label class="form-check-label" for="6.2">2</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="6.3" value="" @change="onprecontemplation(6, 3)" />
                                                <label class="form-check-label" for="6.3">3</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="6.4" value="" @change="onprecontemplation(6, 4)" />
                                                <label class="form-check-label" for="6.4">4</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="6.5" value="" @change="onprecontemplation(6, 5)" />
                            ...
                            <table class="form-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="11" value="" name="question7" @change="oncontemplation(1, 1)" />
                                                <label class="form-check-label" for="11">1</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="12" value="" name="question7" @change="oncontemplation(1, 2)" />
                                                <label class="form-check-label" for="12">2</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="13" value="" name="question7" @change="oncontemplation(1, 3)" />
                                                <label class="form-check-label" for="13">3</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="14" value="" name="question7" @change="oncontemplation(1, 4)" />
                                                <label class="form-check-label" for="14">4</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="15" value="" name="question7" @change="oncontemplation(1, 5)" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="12.1" value="" name="question8" @change="oncontemplation(2, 1)" />
                                                <label class="form-check-label" for="12.1">1</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="12.2" value="" name="question8" @change="oncontemplation(2, 2)" />
                                                <label class="form-check-label" for="12.2">2</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="12.3" value="" name="question8" @change="oncontemplation(2, 3)" />
                                                <label class="form-check-label" for="12.3">3</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="12.4" value="" name="question8" @change="oncontemplation(2, 4)" />
                                                <label class="form-check-label" for="12.4">4</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="12.5" value="" name="question8" @change="oncontemplation(2, 5)" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="13.1" value="" name="question9" @change="oncontemplation(3, 1)" />
                                                <label class="form-check-label" for="13.1">1</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="13.2" value="" name="question9" @change="oncontemplation(3, 2)" />
                                                <label class="form-check-label" for="13.2">2</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="13.3" value="" name="question9" @change="oncontemplation(3, 3)" />
                                                <label class="form-check-label" for="13.3">3</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="13.4" value="" name="question9" @change="oncontemplation(3, 4)" />
                                                <label class="form-check-label" for="13.4">4</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="13.5" value="" name="question9" @change="oncontemplation(3, 5)" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="14.1" value="" name="question10" @change="oncontemplation(4, 1)" />
                                                <label class="form-check-label" for="14.1">1</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="14.2" value="" name="question10" @change="oncontemplation(4, 2)" />
                                                <label class="form-check-label" for="14.2">2</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="14.3" value="" name="question10" @change="oncontemplation(4, 3)" />
                                                <label class="form-check-label" for="14.3">3</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="14.4" value="" name="question10" @change="oncontemplation(4, 4)" />
                                                <label class="form-check-label" for="14.4">4</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="14.5" value="" name="question10" @change="oncontemplation(4, 5)" />
                            ...
                            <table class="form-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="21" value="" name="question11" @change="onaction(1, 1)" />
                                                <label class="form-check-label" for="21">1</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="22" value="" name="question11" @change="onaction(1, 2)" />
                                                <label class="form-check-label" for="22">2</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="23" value="" name="question11" @change="onaction(1, 3)" />
                                                <label class="form-check-label" for="23">3</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="24" value="" name="question11" @change="onaction(1, 4)" />
                                                <label class="form-check-label" for="24">4</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="25" value="" name="question11" @change="onaction(1, 5)" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="22.1" value="" name="question12" @change="onaction(2, 1)" />
                                                <label class="form-check-label" for="22.1">1</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="22.2" value="" name="question12" @change="onaction(2, 2)" />
                                                <label class="form-check-label" for="22.2">2</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="22.3" value="" name="question12" @change="onaction(2, 3)" />
                                                <label class="form-check-label" for="22.3">3</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="22.4" value="" name="question12" @change="onaction(2, 4)" />
                                                <label class="form-check-label" for="22.4">4</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="22.5" value="" name="question12" @change="onaction(2, 5)" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="23.1" value="" name="question13" @change="onaction(3, 1)" />
                                                <label class="form-check-label" for="23.1">1</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="23.2" value="" name="question13" @change="onaction(3, 2)" />
                                                <label class="form-check-label" for="23.2">2</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="23.3" value="" name="question13" @change="onaction(3, 3)" />
                                                <label class="form-check-label" for="23.3">3</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="23.4" value="" name="question13" @change="onaction(3, 4)" />
                                                <label class="form-check-label" for="23.4">4</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="23.5" value="" name="question13" @change="onaction(3, 5)" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="24.1" value="" name="question114" @change="onaction(4, 1)" />
                                                <label class="form-check-label" for="24.1">1</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="24.2" value="" name="question114" @change="onaction(4, 2)" />
                                                <label class="form-check-label" for="24.2">2</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="24.3" value="" name="question114" @change="onaction(4, 3)" />
                                                <label class="form-check-label" for="24.3">3</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="24.4" value="" name="question114" @change="onaction(4, 4)" />
                                                <label class="form-check-label" for="24.4">4</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="24.5" value="" name="question114" @change="onaction(4, 5)" />
                        ...
                        if (
                            ...
                            const response = await this.$axios.post(
                                "intervention/laser-form", {
                                    ...
                                    icd_9_subcode: JSON.stringify(subcodeicd),
