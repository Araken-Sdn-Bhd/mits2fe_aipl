                ...
                <table class="form-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="1" value="" name="question1"
                            @change="onprecontemplation(1, 1)" />
                          <label class="form-check-label" for="1">1</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="2" value="" name="question1"
                            @change="onprecontemplation(1, 2)" />
                          <label class="form-check-label" for="2">2</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="3" value="" name="question1"
                            @change="onprecontemplation(1, 3)" />
                          <label class="form-check-label" for="3">3</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="4" value="" name="question1"
                            @change="onprecontemplation(1, 4)" />
                          <label class="form-check-label" for="4">4</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="5" value="" name="question1"
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="2.1" value="" name="question2"
                            @change="onprecontemplation(2, 1)" />
                          <label class="form-check-label" for="2.1">1</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="2.2" value="" name="question2"
                            @change="onprecontemplation(2, 2)" />
                          <label class="form-check-label" for="2.2">2</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="2.3" value="" name="question2"
                            @change="onprecontemplation(2, 3)" />
                          <label class="form-check-label" for="2.3">3</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="2.4" value="" name="question2"
                            @change="onprecontemplation(2, 4)" />
                          <label class="form-check-label" for="2.4">4</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="2.5" value="" name="question2"
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="3.1" value="" name="question3"
                            @change="onprecontemplation(3, 1)" />
                          <label class="form-check-label" for="3.1">1</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="3.2" value="" name="question3"
                            @change="onprecontemplation(3, 2)" />
                          <label class="form-check-label" for="3.2">2</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="3.3" value="" name="question3"
                            @change="onprecontemplation(3, 3)" />
                          <label class="form-check-label" for="3.3">3</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="3.4" value="" name="question3"
                            @change="onprecontemplation(3, 4)" />
                          <label class="form-check-label" for="3.4">4</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="3.5" value="" name="question3"
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="4.1" value="" name="question4"
                            @change="onprecontemplation(4, 1)" />
                          <label class="form-check-label" for="4.1">1</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="4.2" value="" name="question4"
                            @change="onprecontemplation(4, 2)" />
                          <label class="form-check-label" for="4.2">2</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="4.3" value="" name="question4"
                            @change="onprecontemplation(4, 3)" />
                          <label class="form-check-label" for="4.3">3</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="4.4" value="" name="question4"
                            @change="onprecontemplation(4, 4)" />
                          <label class="form-check-label" for="4.4">4</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="4.5" value="" name="question4"
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="5.1" value="" name="question5"
                            @change="onprecontemplation(5, 1)" />
                          <label class="form-check-label" for="5.1">1</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="5.2" value="" name="question5"
                            @change="onprecontemplation(5, 2)" />
                          <label class="form-check-label" for="5.2">2</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="5.3" value="" name="question5"
                            @change="onprecontemplation(5, 3)" />
                          <label class="form-check-label" for="5.3">3</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="5.4" value="" name="question5"
                            @change="onprecontemplation(5, 4)" />
                          <label class="form-check-label" for="5.4">4</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="5.5" value="" name="question5"
                ...
                <table class="form-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="11" value="" name="question7"
                            @change="oncontemplation(1, 1)" />
                          <label class="form-check-label" for="11">1</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="12" value="" name="question7"
                            @change="oncontemplation(1, 2)" />
                          <label class="form-check-label" for="12">2</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="13" value="" name="question7"
                            @change="oncontemplation(1, 3)" />
                          <label class="form-check-label" for="13">3</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="14" value="" name="question7"
                            @change="oncontemplation(1, 4)" />
                          <label class="form-check-label" for="14">4</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="15" value="" name="question7"
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="12.1" value="" name="question8"
                            @change="oncontemplation(2, 1)" />
                          <label class="form-check-label" for="12.1">1</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="12.2" value="" name="question8"
                            @change="oncontemplation(2, 2)" />
                          <label class="form-check-label" for="12.2">2</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="12.3" value="" name="question8"
                            @change="oncontemplation(2, 3)" />
                          <label class="form-check-label" for="12.3">3</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="12.4" value="" name="question8"
                            @change="oncontemplation(2, 4)" />
                          <label class="form-check-label" for="12.4">4</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="12.5" value="" name="question8"
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="13.1" value="" name="question9"
                            @change="oncontemplation(3, 1)" />
                          <label class="form-check-label" for="13.1">1</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="13.2" value="" name="question9"
                            @change="oncontemplation(3, 2)" />
                          <label class="form-check-label" for="13.2">2</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="13.3" value="" name="question9"
                            @change="oncontemplation(3, 3)" />
                          <label class="form-check-label" for="13.3">3</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="13.4" value="" name="question9"
                            @change="oncontemplation(3, 4)" />
                          <label class="form-check-label" for="13.4">4</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="13.5" value="" name="question9"
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="14.1" value="" name="question10"
                            @change="oncontemplation(4, 1)" />
                          <label class="form-check-label" for="14.1">1</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="14.2" value="" name="question10"
                            @change="oncontemplation(4, 2)" />
                          <label class="form-check-label" for="14.2">2</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="14.3" value="" name="question10"
                            @change="oncontemplation(4, 3)" />
                          <label class="form-check-label" for="14.3">3</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="14.4" value="" name="question10"
                            @change="oncontemplation(4, 4)" />
                          <label class="form-check-label" for="14.4">4</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="14.5" value="" name="question10"
                ...
                <table class="form-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="21" value="" name="question11"
                            @change="onaction(1, 1)" />
                          <label class="form-check-label" for="21">1</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="22" value="" name="question11"
                            @change="onaction(1, 2)" />
                          <label class="form-check-label" for="22">2</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="23" value="" name="question11"
                            @change="onaction(1, 3)" />
                          <label class="form-check-label" for="23">3</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="24" value="" name="question11"
                            @change="onaction(1, 4)" />
                          <label class="form-check-label" for="24">4</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="25" value="" name="question11"
                            @change="onaction(1, 5)" />
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="22.1" value="" name="question12"
                            @change="onaction(2, 1)" />
                          <label class="form-check-label" for="22.1">1</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="22.2" value="" name="question12"
                            @change="onaction(2, 2)" />
                          <label class="form-check-label" for="22.2">2</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="22.3" value="" name="question12"
                            @change="onaction(2, 3)" />
                          <label class="form-check-label" for="22.3">3</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="22.4" value="" name="question12"
                            @change="onaction(2, 4)" />
                          <label class="form-check-label" for="22.4">4</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="22.5" value="" name="question12"
                            @change="onaction(2, 5)" />
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="23.1" value="" name="question13"
                            @change="onaction(3, 1)" />
                          <label class="form-check-label" for="23.1">1</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="23.2" value="" name="question13"
                            @change="onaction(3, 2)" />
                          <label class="form-check-label" for="23.2">2</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="23.3" value="" name="question13"
                            @change="onaction(3, 3)" />
                          <label class="form-check-label" for="23.3">3</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="23.4" value="" name="question13"
                            @change="onaction(3, 4)" />
                          <label class="form-check-label" for="23.4">4</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="23.5" value="" name="question13"
                            @change="onaction(3, 5)" />
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="24.1" value="" name="question114"
                            @change="onaction(4, 1)" />
                          <label class="form-check-label" for="24.1">1</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="24.2" value="" name="question114"
                            @change="onaction(4, 2)" />
                          <label class="form-check-label" for="24.2">2</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="24.3" value="" name="question114"
                            @change="onaction(4, 3)" />
                          <label class="form-check-label" for="24.3">3</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="24.4" value="" name="question114"
                            @change="onaction(4, 4)" />
                          <label class="form-check-label" for="24.4">4</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" id="24.5" value="" name="question114"
                            @change="onaction(4, 5)" />
                  ...
                  <div class="accordion-item">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                      ...
                      <div class="accordion-body">
                        <div class="row mb-3">
                          <label class="col-sm-4 col-form-label">Location Of Services<small
                            ...
                            <div class="col-md-6 mb-3">
                              ...
                              <div>
                                <div class="mt-2 align-items-flex-start">
                                  <select id='subcode' class="form-select multiselect" multiple="multiple"
                                    style="width:100%">
                          ...
                          <div class="row">
                            <div class="col-md-6 mb-3">
                              ...
                              <select class="form-select" v-model="additional_code_id"
                                @change="onCategorycodebind2($event)">
                                <option value="0">Select code</option>
                            ...
                            <div class="col-md-6 mb-3">
                              ...
                              <div>
                                <div class="mt-2 align-items-flex-start">
                                  <select id='addsubcode' class="form-select multiselect" multiple="multiple"
                                    style="width:100%">
                                    <option value="0">Select sub code</option>
                                    <option v-for="catcode in add_icdcatcodelist" v-bind:key="catcode.id"
                                      v-bind:value="catcode.id">
                                      {{ catcode.icd_code }}
                                      {{ catcode.icd_name }}
                                    </option>
          ...
          try {
            ...
            if (
              ...
              const response = await this.$axios.post(
                ...
                icd_9_subcode: JSON.stringify(subcode),
