                          ...
                          <tbody>
                            <tr>
                              <td>
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox"
                                  value="Psychoterapy" v-model="psychoterapy" id="int-1">
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox"
                                  value="Pain Management" v-model="painmgt" id="int-2">
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox"
                                  value="Insomnia/Eating Disorder" v-model="insomniaeating" id="int-3">
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox"
                                  value="Learning/Development" v-model="learndevelop" id="int-4">
                              ...
                              <td>
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox"
                                  value="Marital and Family Therapy" v-model="maritalfamily" id="int-5">
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox"
                                  value="Stress and Anger Management" v-model="stressanger" id="int-6">
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox"
                                  value="Addiction" v-model="addict" id="int-7">
