                            ...
                            <table class="notes">
                                ...
                                <tbody v-if="patientdetails">
                                    ...
                                    <tr>
                                      ...
                                      <td><textarea disabled v-model="history" class="form-control" placeholder="Enter Description" rows="15"></textarea></td>
                                  </tr>
                                  <tr>
                                      <th>Examination<small style="color:red">*</small> :</th>
                                      <td><textarea disabled v-model="examination" class="form-control" placeholder="Enter Description" rows="15"></textarea></td>
                                  </tr>
                                  <tr>
                                      <th>Diagnosis<small style="color:red">*</small> :</th>
                                      <td><textarea disabled v-model="diagnosis" class="form-control textarea" name=""></textarea></td>
                                  </tr>
                                  <tr>
                                      <th>Result of investigation<small style="color:red">*</small> :</th>
                                      <td><textarea disabled v-model="result_of_investigation" class="form-control" placeholder="Enter Description"></textarea></td>
                                  </tr>
                                  <tr>
                                      <th>Treatment<small style="color:red">*</small> :</th>
                                      <td><textarea disabled v-model="treatment" class="form-control" placeholder="Enter Description" rows="15" name=""></textarea></td>
                                  </tr>
                                  <tr>
                                      <th>Purpose of referral<small style="color:red">*</small> :</th>
                                      <td><textarea disabled v-model="purpose_of_referral" class="form-control" placeholder="Enter Description" name=""></textarea></td>
                                  </tr>
                                </tbody>
                            </table>
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <textarea disabled v-model="medication_prescription" class="form-control textarea" placeholder="Please Type Prescription Here"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <table class="notes">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input disabled type="text" class="form-control" name="" v-model="name" /></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input disabled type="text" class="form-control" name="" v-model="hospital" /></td>
                                    </tr>
                                </tbody>
                            </table>
