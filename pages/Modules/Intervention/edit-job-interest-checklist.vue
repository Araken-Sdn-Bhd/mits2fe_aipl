                  ...
                  <div class="card mb-4">
                      <div class="card-body new-form">
                                      ...
                                      <td>
                                          <table>
                                              <tbody>
                                                  ...
                                                  <tr>
                                                      <th>Nationality:</th>
                                                      <td>{{ patientdetails.nationality }}</td>
                                                  </tr>
                                              </tbody>
                                          </table>
                                      </td>
                          ...
                          <table class="notes th-width table-padding">
                              <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <div class="form-check">
                                              <input class="form-check-input" type="checkbox" value="1" id="1.2" v-model="agree_if_mentari_find_job_for_you" />
                              ...
                              <table class="th-auto th-bg">
                                  ...
                                  <tbody>
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                              <input type="checkbox" name="" value="Factory Worker" v-model="factory_worker_job_interested" />Yes
                                          </td>
                                          <td>
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                              <input type="checkbox" name="" value="Security Guard" v-model="security_guard_job_interested" />Yes
                                          </td>
                                          <td>
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                              <input type="checkbox" name="" value="Laundry Worker" v-model="laundry_worker_job_interested" />Yes
                                          </td>
                                          <td>
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        ...
                                        <div class="row mb-3 align-items-flex-start">
                                            ...
                                            <div class="col-sm-8">
                                                <select id="additionalboxdiagnosis" v-model="additional_diagnosis" class="form-select multiselectadditionalsubcode" multiple="multiple">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="mt-2 align-items-flex-start">
                                                        <select id="subcodeicd" v-model="sub_code_id" style="width:100%" class="form-select multiselectadditional" multiple="multiple">
                          ...
                          <div class="d-flex three-btn">
                              ...
                              <div class="ml-auto" :class="SidebarAccess != 1 ? 'hide' : ''" v-if="type == 'edit'">
