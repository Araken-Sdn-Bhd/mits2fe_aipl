                                ...
                                <table class="job-search-table" id="companydetail">
                                    ...
                                    <tbody class="optionBox">
                                        <tr class="block" v-for="(job, index) in jobSDESCRIPTION" :key="index">
                                            <td><input type="text" required class="form-control name" v-model="job.company_name" disabled /></td>
                                            <td><input type="text" required class="form-control job" v-model="job.job_applied" disabled /></td>
                                            <td>
                                                <input type="date" required class="form-control appdate" v-model="job.application_date" disabled />
                                            </td>
                                            <td><input type="date" required class="form-control intdate" v-model="job.interview_date" disabled/></td>
                                            <td>
                                            </td>
                                        </tr>
                                    </tbody>
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-lg-8 col-sm-12">
                                                    ...
                                                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" disabled
                                                        value="assisstance" v-model="category_services" />
                                                    <label class="form-check-label" for="inlineRadio1">Assisstance / Supervision</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="inlineRadioOptions2" id="inlineRadio2" disabled
                                                        value="clinical-work" v-model="category_services" />
                                                    <label class="form-check-label" for="inlineRadio2">Clinical Work / Procedure
                                                    </label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="inlineRadioOptions3" id="inlineRadio3" disabled
