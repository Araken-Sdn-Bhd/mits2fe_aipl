                        ...
                        <form class="mt-2">
                            <div class="col-lg-10 offset-lg-1 col-sm-12 pd-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6" v-if="otherOccStatus ">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" v-model="other_occupationStatus" placeholder="please specify" />
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="permanent-resident box mb-0" v-if="citizentype == 'Permanent Resident'">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <input type="tel" class="form-control" placeholder="xxxxxx-xx-xxxx" @keyup="OnnricNo1" v-model="nric_no1" @change="validateIC" v-on:keypress="NumbersOnly" />
                                                <Error :message="error" v-if="error" />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label class="form-label">Religion<small>*</small></label>
                                    ...
                                    <div class="col-sm-6" v-if="otherReligion">
                                        <div class="mb-3">
                                            <label class="form-label">Please Specify</label>
                                            <input type="text" class="form-control" v-model="other_religion" placeholder="Please Specify Other Religion Status" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label class="form-label">Ethnic Group/Race<small>*</small></label>
                                    ...
                                    <div class="col-sm-6" v-if="otherRace">
                                        <div class="mb-3">
                                            <label class="form-label">Please Specify</label>
                                            <input type="text" class="form-control" v-model="other_race" placeholder="Please Specify Other Race Status" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label class="form-label">Marital Status<small>*</small></label>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label class="form-label">Highest Education<small>*</small></label>
                                    ...
                                    <div class="col-sm-6" v-if="otherEducation">
                                        <div class="mb-3">
                                            <label class="form-label">Please Specify</label>
                                            <input type="text" class="form-control" v-model="other_education" placeholder="Please Specify Other Education Status" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label class="form-label">Household Income Status(monthly)<small>*</small></label>
                                ...
                                <div class="d-flex align-items-center mt-3">
                                    ...
                                    <a v-if="!Id" @click="submitRegistration" class="btn btn-warning btn-text ml-auto"><i class="fa fa-save"></i> Save</a>
                                    <a v-if="Id" @click="submitRegistration" class="btn btn-warning btn-text ml-auto"><i class="fa fa-save"></i> Update</a>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    methods: {
        ...
        async submitRegistration() {
            ...
            try {
                ...
                if (!this.birth_date) {
                    this.errorList.push("Date of birth is required.");
                    this.Isvalidate = false;
                    this.submitting = false;
                }
                if (!this.sex) {
                ...
                if (this.otherReligion) {
                  if(!this.other_religion) {
                    this.errorList.push("Please specify other religion.");
                    this.submitting = false;
                  }
                }
                if (!this.race_id) {
                    this.errorList.push("Race is required.");
                    this.submitting = false;
                }
                if (this.otherRace) {
                  if(!this.other_race) {
                    this.errorList.push("Please specify other race.");
                    this.submitting = false;
                  }
                }
                if (!this.marital_id) {
                    this.errorList.push("Marital Status is required.");
                    this.submitting = false;
                }
                if (this.otherMarital) {
                  if(!this.other_maritalList) {
                    this.errorList.push("Please specify other marital status.");
                    this.submitting = false;
                  }
                }
                ...
                if (this.otherEducation) {
                  if(!this.other_education) {
                    this.errorList.push("Please specify other education level.");
                    this.submitting = false;
                  }
                }
        ...
        async GetPatientdetails() {
            ...
            if (response.data.code == 200) {
                ...
                this.sex = response.data.list[0].gender[0].id;
                ...
                this.race_id = response.data.list[0].race[0].id;
