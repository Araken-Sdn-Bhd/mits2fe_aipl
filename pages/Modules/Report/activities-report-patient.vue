...
<div>
                        ...
                        <option value="3">Completed</option> -->
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" v-model="employement_status">
                                                <option value="">Please Select</option>
                                                <option v-for="stat in employementstatlist" v-bind:key="stat.id" v-bind:value="stat.id">
                                                    {{ stat.section_value}}
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" v-model="case_manager">
                                                <option value="">Please Select</option>
                                                <option v-for="listemp in cmanagerlist" v-bind:key="listemp.id" v-bind:value="listemp.id">
                                                    {{ listemp.name }}
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" v-model="employer_list">
                                                <option value="">Please Select</option>
                                                <option v-for="employer in employerlist" v-bind:key="employer.id" v-bind:value="employer.id">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" v-model="current_intervention">
                                                <option value="">Please Select</option>
                                                <option v-for="cintervention in currentinterventionlist" v-bind:key="cintervention.id" v-bind:value="cintervention.id">
                            ...
                            <div class="btn-width d-flex">
                                <div v-if="this.appointment_type" class="ml-auto" :class="SidebarAccess!=1?'hide':''">
                                    ...
                                    <downloadexcel v-if="this.appointment_type == 1" class="btn btn-success btn-text" :header="header" :before-generate="startDownload" :before-finish="finishDownload" :json_data="ReportList" :fetch="Ongenerateexel" :fields="json_fields" :excelname="excelname" :sheetname="sheetname" worksheet="CONSULTATION_CLINIC_REPORT" :name=excelname>
                                        <i class="fa fa-file-excel"></i> Generate Excel
                                    </downloadexcel>

                                    <downloadexcel v-if="this.appointment_type == 3" class="btn btn-success btn-text" :header="header" :before-generate="startDownload" :before-finish="finishDownload" :json_data="ReportList" :fetch="Ongenerateexel" :fields="json_fieldsSE" :excelname="excelname" :sheetname="sheetname" worksheet="SE_REPORT" :name=excelname>
                                        <i class="fa fa-file-excel"></i> Generate Excel
                                    </downloadexcel>

                                    <downloadexcel v-if="this.appointment_type == 4" class="btn btn-success btn-text" :header="header" :before-generate="startDownload" :before-finish="finishDownload" :json_data="ReportList" :fetch="Ongenerateexel" :fields="json_fieldsETP" :excelname="excelname" :sheetname="sheetname" worksheet="ETP_REPORT" :name=excelname><i class="fa fa-file-excel"></i> Generate Excel
                                    </downloadexcel>

                                    <downloadexcel v-if="this.appointment_type == 5" class="btn btn-success btn-text" :header="header" :before-generate="startDownload" :before-finish="finishDownload" :json_data="ReportList" :fetch="Ongenerateexel" :fields="json_fieldsJC" :excelname="excelname" :sheetname="sheetname" worksheet="JOB_CLUB_REPORT" :name=excelname><i class="fa fa-file-excel"></i> Generate Excel
                                    </downloadexcel>

                                    <downloadexcel v-if="this.appointment_type == 6" class="btn btn-success btn-text" :header="header" :before-generate="startDownload" :before-finish="finishDownload" :json_data="ReportList" :fetch="Ongenerateexel" :fields="json_fieldsCPS" :excelname="excelname" :sheetname="sheetname" worksheet="CPS_REPORT" :name=excelname>
                                        <i class="fa fa-file-excel"></i> Generate Excel
                                    </downloadexcel>
    ...
    <div id="result" class="hide" ref="result" style="background: #fff" v-if="this.appointment_type == 1">
    ...
    <div id="result" class="hide" ref="result" style="background: #fff" v-if="this.appointment_type == 3">
    ...
    <div id="result" class="hide" ref="result" style="background: #fff" v-if="this.appointment_type == 4">
    ...
    <div id="result" class="hide" ref="result" style="background: #fff" v-if="this.appointment_type == 5">
    ...
    <div id="result" class="hide" ref="result" style="background: #fff" v-if="this.appointment_type == 6">
