...
<div>
                            ...
                            <form>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="" placeholder="Enter Event/ Program" v-model="event" />
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select select-others" v-model="toc">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div v-if="this.location == 'mentari'" class="mb-3 mentari selected-box">
                                            ...
                                            <select class="form-select select-others" v-model="location_value">
                                                <option value="">Please Select</option>
                                        ...
                                        <div v-if="this.location == 'Others'" class="mb-3 Others selected-box">
                                            ...
                                            <input type="text" class="form-control" placeholder="Please Specify" v-model="others_value" />
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" v-model="aoi">
                                                <option value="">Please Select</option>
                                                <option v-for="area in areaslist" v-bind:key="area.name" v-bind:value="area.name">
                                                    {{ area.name }}
                                                </option>
                                            </select>
                                        </div>
                                ...
                                <div class="btn-width d-flex">
                                    <div class="ml-auto" :class="SidebarAccess!=1?'hide1':''">
                                        ...
                                        <downloadexcel class="btn btn-success btn-text" :header="header" :before-generate="startDownload" :before-finish="finishDownload" :json_data="ReportList" :fetch="Ongenerateexel" :fields="json_fields" :excelname="excelname" :sheetname="sheetname" worksheet="General Report" :name=excelname>
    ...
    <div id="result" class="hide" ref="result" style="background: #fff">
        <div>
            <h2>REPORT OF VOLUNTEER, OUTREACH AND NETWORKING</h2>
        </div>
