            ...
            <div class="container-fluid px-4">
                <div class="card mb-4 mt-5">
                    <div class="card-header">
                        ...
                        <a href="#" class="visibility-h"><i class="fa fa-user-edit"></i></a>
                    </div>
                    <div class="card-body mt-3">
                        ...
                        <div class="group notshow-box">
                            ...
                            <div class="row mb-3">
                                <label for="" class="col-sm-4 col-form-label">Does your group represent an organization?<span>*</span></label>
                                <div class="col-sm-8 organization-box">
                                    <div class="form-check form-check-inline" id="change">
                                        <input disabled class="form-check-input" type="radio" name="organization" id="organization-yes" value="option1" v-model="is_represent_org" />
                                        <label class="form-check-label" for="organization-yes">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input disabled class="form-check-input" type="radio" name="organization" id="organization-no" value="organization-no" v-model="is_represent_org" />
                                    ...
                                    <div class="organization-no organiz-box">
                                        <div class="mt-3 mb-3">
                                            <label class="form-label">How many group members do you have?<span>*</span></label>
                                            <span class="form-control">{{ this.members_count }}</span>
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">What is the background of your group member?<span>*</span></label>
                            ...
                            <div class="row mb-3">
                                <label for="" class="col-sm-4 col-form-label">Are you the representative of your group?<span>*</span></label>
                                <div class="col-sm-8 representative-box">
                                    <div class="form-check form-check-inline">
                                        <input disabled class="form-check-input" type="radio" name="representative" id="representative-yes" value="1" v-model="is_you_represenative" @change="OnchangeIsrepresent('1')" />
                                        <label class="form-check-label" for="representative-yes">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input disabled class="form-check-input" type="radio" name="representative" id="representative-no" value="0" v-model="is_you_represenative" @change="OnchangeIsrepresent('0')" />
                            ...
                            <div class="representative-no represen-box hide" v-if="!is_you_represenative">
                            ...
                            <div class="representative-yes represen-box" v-if="is_you_represenative">
                                <div>
                                    <label for="" class="col-sm-4 font-italic">Please provide personal details below.</label>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-8">
                                        <input disabled type="date" class="form-control" id="" v-model="Gdob" />
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select disabled class="form-select" v-model="Geducation_id">
                                            <option value="0">Please Select</option>
                                            <option v-for="ed in GEducationList" v-bind:key="ed.id" v-bind:value="ed.id">
                                                {{ ed.section_value }}
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select disabled class="form-select" v-model="Goccupation_sector_id">
                                            <option value="0">Please Select</option>
                                            <option v-for="os in GOccupationList" v-bind:key="os.id" v-bind:value="os.id">
                                                {{ os.section_value }}
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="row mb-3 mt-2">
                                    ...
                                    <div class="col-sm-8">
                                        <select disabled class="form-select" v-model="Gbranch_id">
                                            <option value="0">Please Select</option>
                                            <option v-for="brn in GBranchList" v-bind:key="brn.id" v-bind:value="brn.id">
                                ...
                                <div class="row mb-3 mt-2">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="form-check">
                                            <input disabled class="form-check-input" type="radio" name="involvement" id="volunteerism1" v-model="Garea_of_involvement" value="Volunteerism" />
                                            <label class="form-check-label" for="volunteerism1">
                                                Volunteerism
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input disabled class="form-check-input" type="radio" name="involvement" id="outreach-project1" v-model="Garea_of_involvement" value="Outreach Project Collaboration" />
                                            <label class="form-check-label" for="outreach-project1">
                                                Outreach Project Collaboration
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input disabled class="form-check-input" type="radio" name="involvement" id="networking1" v-model="Garea_of_involvement" value="Networking Make a Contribution" />
                                ...
                                <div class="areas-involvement" id="volunteerism1show" v-if="Garea_of_involvement=='Volunteerism'">
                                    ...
                                    <div class="row mb-3 mt-2">
                                        ...
                                        <div class="col-sm-8 radio-box">
                                            <div class="form-check form-check-inline">
                                                <input disabled class="form-check-input" type="radio" name="experience" id="experience-yes1" value="1" v-model="Gis_voluneering_exp" @change="OnChangeexperiance('1')" />
                                                <label class="form-check-label" for="experience-yes1">Yes</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input disabled class="form-check-input" type="radio" name="experience" id="experience-no1" value="0" v-model="Gis_voluneering_exp" @change="OnChangeexperiance('0')" />
                                    ...
                                    <div class="row mb-3 mt-2">
                                        ...
                                        <div class="col-sm-8 professional-box">
                                            <div class="form-check form-check-inline">
                                                <input disabled class="form-check-input" type="radio" name="professional" id="professional-yesG" value="1" v-model="Gis_mental_health_professional" @change="Onhealthprofession('1')" />
                                                <label class="form-check-label" for="professional-yesG">Yes</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input disabled class="form-check-input" type="radio" name="professional" id="professional-noG" value="0" v-model="Gis_mental_health_professional" @change="Onhealthprofession('0')" />
                                            ...
                                            <div class="professional-yesG profess-box" v-if="Gis_mental_health_professional=='1'">
                                                <div class="mt-3">
                                                    ...
                                                    <input disabled class="form-control" type="file" id="formFile" @change="GselectFile" />
                                                </div>
                  ...
                  <label class="form-check-label" for="Consultation/Counselling">
                    Consultation/Counselling
                                            ...
                                            <div class="professional-noG profess-box" v-if="Gis_mental_health_professional=='0'">
                                                <div class="mt-3">
                                                    <label for="formFile" class="form-label">Relevant Mentari Service That You Want To Be Involved<span>*</span></label>
                                                    <div class="form-check">
                                                        <input disabled class="form-check-input" type="checkbox" value="Consultation/Counselling" id="Consultation/Counselling" v-model="Consultation" />
                                                        <label class="form-check-label" for="Consultation/Counselling">
                                                            Consultation/Counselling
                                                        </label>
                                                    </div>
                                ...
                                <div class="areas-involvement" id="outreach-project1show" v-if="Garea_of_involvement=='Outreach Project Collaboration'">
                                    ...
                                    <div class="row mb-3 mt-2">
                                        ...
                                        <div class="col-sm-8">
                                            <input disabled type="text" class="form-control" name="" v-model="Gproject_name" />
                                        </div>
                                    </div>
                                    <!-- row-close -->
                                    ...
                                    <div class="row mb-3 mt-2">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea disabled class="form-control textarea" rows="3" v-model="Gproject_background"></textarea>
                                        </div>
                                    </div>
                                    <!-- row-close -->
                                    ...
                                    <div class="row mb-3 mt-2">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea disabled class="form-control textarea" rows="3" v-model="Gproject_objectives"></textarea>
                                        </div>
                                    </div>
                                    <!-- row-close -->
                                    ...
                                    <div class="row mb-3 mt-2">
                                        ...
                                        <div class="col-sm-8">
                                            <input disabled type="text" class="form-control" name="" v-model="Gtarget_audience" />
                                        </div>
                                    </div>
                                    <!-- row-close -->
                                    ...
                                    <div class="row mb-3 mt-2">
                                        ...
                                        <div class="col-sm-8">
                                            <input disabled type="number" class="form-control" name="" v-model="Gno_of_paricipants" />
                                        </div>
                                    </div>
                                    <!-- row-close -->
                                    ...
                                    <div class="row mb-3 mt-2">
                                        ...
                                        <div class="col-sm-8">
                                            <input disabled type="text" class="form-control" name="" v-model="Gtime_frame" />
                                        </div>
                                    </div>
                                    <!-- row-close -->
                                    ...
                                    <div class="row mb-3 mt-2">
                                        ...
                                        <div class="col-sm-8">
                                            <input disabled type="number" class="form-control" name="" v-model="Gestimated_budget" />
                                        </div>
                                    </div>
                                    <!-- row-close -->
                                    ...
                                    <div class="row mb-3 mt-2">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea disabled class="form-control textarea" rows="3" v-model="Gproject_scopes"></textarea>
                                        </div>
                                    </div>
                                    <!-- row-close -->
                                    ...
                                    <div class="row mb-3 mt-3">
                                        ...
                                        <div class="col-sm-8 project-location-box">
                                            <div class="form-check form-check-inline">
                                                <input disabled class="form-check-input" type="radio" name="project-location" id="project-location-mentariG" value="mentari" v-model="Gproject_loaction" />
                                                <label class="form-check-label" for="project-location-mentariG">Mentari</label>
                                            </div>

                                            <div class="form-check form-check-inline">
                                                <input disabled class="form-check-input" type="radio" name="project-location" id="project-location-othersG" value="others" v-model="Gproject_loaction" />
                                                <label class="form-check-label" for="project-location-othersG">Others</label>
                                            </div>
                                            ...
                                            <div class="mentari profess-box" v-if="Gproject_loaction=='mentari'">
                                                <div class="mt-3">
                                                    <select disabled class="form-select" v-model="Gproject_branch">
                                                        ...
                                                        <option v-for="brn in GBranchList" v-bind:key="brn.hospital_branch_name" v-bind:value="brn.hospital_branch_name">
                                                            {{ brn.hospital_branch_name }}
                                                        </option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="project-location-others profess-box" v-if="Gproject_loaction!='mentari'">
                                                <div class="mt-3">
                                                    <input disabled type="text" class="form-control" placeholder="Please Specify" name="" v-model="Gother_loaction" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3 mt-2">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea disabled class="form-control textarea" rows="3" v-model="Gtarget_outcome"></textarea>
                                        </div>
                                    </div>
                                    <!-- row-close -->
                                    ...
                                    <div class="row mb-3 mt-2">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea disabled class="form-control textarea" rows="3" v-model="Gfollowup_projects"></textarea>
                                        </div>
                                    </div>
                                    <!-- row-close -->
                  ...
                  <label class="form-check-label" for="Consultation/Counselling">
                    Consultation/Counselling
                                ...
                                <div class="areas-involvement" id="networking1show" v-if="Garea_of_involvement=='Networking Make a Contribution'">
                                    ...
                                    <div class="row mb-3 mt-2">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea disabled class="form-control textarea" rows="3" v-model="Gcontribution"></textarea>
                                        </div>
                                    </div>
                                    <!-- row-close -->
                                    ...
                                    <div class="row mb-3 mt-2">
                                        <label for="" class="col-sm-4 col-form-label">Estimated Budget<span>*</span></label>
                                        <div class="col-sm-8">
                                            <input disabled type="number" class="form-control" name="" v-model="Gbudget" />
                                        </div>
                                    </div>
                                    <!-- row-close -->
                                    ...
                                    <div class="row mb-3 mt-3">
                                        ...
                                        <div class="col-sm-8 project-location-box">
                                            <div class="form-check form-check-inline">
                                                <input disabled class="form-check-input" type="radio" name="project-location" id="project-location-mentariG1" value="project-location-mentari" v-model="Gnetwotkproject_loaction" />
                                                <label class="form-check-label" for="project-location-mentariG1">Mentari</label>
                                            </div>

                                            <div class="form-check form-check-inline">
                                                <input disabled class="form-check-input" type="radio" name="project-location" id="project-location-othersG1" value="project-location-others" v-model="Gnetwotkproject_loaction" />
                                                <label class="form-check-label" for="project-location-othersG1">Others</label>
                                            </div>
                                            ...
                                            <div class="project-location-others profess-box" v-if="Gnetwotkproject_loaction!='project-location-mentari'">
                                                <div class="mt-3">
                                                    <input disabled type="text" class="form-control" placeholder="Please Specify" name="" v-model="Gnetworkother" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3 mt-2">
                                        <label for="" class="col-sm-4 col-form-label">Number of Participants<span>*</span></label>
                                        <div class="col-sm-8">
                                            <input disabled type="number" class="form-control" name="" v-model="Gnetworkno_of_paricipants" />
                                        </div>
                                    </div>
                                    <!-- row-close -->
                    ...
                    Consultation/Counselling
                            ...
                            <div class="d-flex align-items-center mt-4">
                                ...
                                <div class="row col-sm-9">
                                    <label for="" class="col-sm-4 col-form-label">Screening Done</label>
                                    <div class="col-sm-8">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="screening-yes" value="1" v-model="screening_mode" />
                                            <label class="form-check-label" for="screening-yes">Yes</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="screening-no" value="0" v-model="screening_mode" />
                                            <label class="form-check-label" for="screening-no">No</label>
                                        </div>
                                    </div>
                                </div>
                                <br><br>
                                <div class="d-flex mt-4 btn-mb">
                                    ...
                                    <button @click="OnSubmit" class="btn btn-warning btn-text ml-auto">
...
export default {
    ...
    methods: {
        ...
        async GetList() {
            ...
            if (this.Gstate_id) {
                const response = await this.$axios.post(
                    "address/" + this.Gstate_id + "/stateWisePostcodeList", {
                        headers
                    }
                );
                if (response.data.code == 200 || response.data.code == "200") {
        ...
        async OnGroupVolunteerism() {
            try {
                ...
                if (
                    ...
                    body.append("screening_mode", this.screening_mode);
                    body.append("added_by", this.userdetails.user.id);
                    body.append("section", "group");
                    body.append("is_represent_org", "0");
                    body.append("members_count", this.members_count);
                    ...
                    const response = await this.$axios.post("von/update-record", body, {
                        headers,
                    });
                    console.log("my console response", response.data);
                    if (response.data.code == 200 || response.data.code == "200") {
        ...
        async OnGroupOutreachProjectCollaboration() {
            try {
                ...
                if (!this.Gproject_loaction) {
                    ...
                    if (this.Gproject_loaction == "others") {
        ...
        async editrecord() {
            ...
            if (response.data.code == 200) {
                this.Gname = response.data.list.name;
                this.Gdob = response.data.list.dob;
                this.Gemail = response.data.list.email;
                this.Gphone_number = response.data.list.phone_number;
                this.Gaddress = response.data.list.address;
                if (this.Gaddress) {
                    var add = this.Gaddress.split("\n");
                ...
                this.Gpostcode_id = response.data.list.postcode;
                this.Gcity_id = response.data.list.city;
                this.Gstate_id = response.data.list.state;
                this.Geducation_id = response.data.list.education;
                this.Goccupation_sector_id = response.data.list.occupation_sector;
                this.Gbranch_id = response.data.list.branch_id;
                ...
                if (this.Gmentari_services) {
                    ...
                    service.forEach((val) => {
                        if (val == "Consultation/Counselling") {
                            ...
                            this.awareness = val;
                        } else if (val == "Recreational Therapy") {
                            this.recreational = val;
                        } else if (val == "Others") {
                            this.other = val;
                        } else if (val != ",") {
                            this.Others = val;
                ...
                if (response.data.list.area_of_involvement == "Volunteerism") {
                    ...
                    if (this.Gis_mental_health_professional == 1) {} else {}
                    ...
                    this.Gproject_name = response.data.list.project_name;
                    this.Gproject_background = response.data.list.project_background;
                    this.Gproject_objectives = response.data.list.project_objectives;
                    this.Gtarget_audience = response.data.list.target_audience;
                    this.Gno_of_paricipants = response.data.list.no_of_paricipants;
                    this.Gtime_frame = response.data.list.time_frame;
                    ...
                    this.Gproject_branch = response.data.list.project_loaction_value;
                } else if (
                    response.data.list.area_of_involvement ==
                    "Networking Make a Contribution"
                ) {
                    this.Gcontribution = response.data.list.contribution;
