          ...
          <div class="page-title">
            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                <ul class="sub-tab">
                  <li>
                    <a href="#" class="active">Place of Occurrence</a>
                  </li>
                </ul>

                <div class="content-subtab">
                  <form class="g-3 mt-3" method="post" @submit.prevent="insertplace">
         ...
         <button type="submit" class="btn btn-warning btn-text" v-if="!settingId">
          <i class="fa fa-plus"></i> Add Parameter
                  ...
                  <div class="table-title">
                    <h3>List of Place of Occurrence</h3>
                  </div>
                  <table
...
export default {
  ...
  methods: {
    async insertplace() {
      ...
      try {
        if (!this.place) {
          this.errorList.push("Place-of-occurrence is required");
        }
        if (!this.index) {
          ...
          const response = await this.$axios.post(
            "/general-setting/add",
            {
              ...
              section: "place-of-occurrence",
              section_value: this.place,
...
this.$swal.fire(
    ...
    async GetSettingList() {
      ...
      const response = await this.$axios.get(
        "general-setting/lists?section=" + "place-of-occurrence",
        { headers }
      );
    ...
    async editsetting(data) {
      ...
      if (response.data.code == 200) {
        ...
        this.place = response.data.setting[0].section_value;
