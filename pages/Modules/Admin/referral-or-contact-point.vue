          ...
          <div class="page-title">
            ...
            <div class="card mb-4">
              <div class="card-header icon-title">
                ...
                <h4>Referral or Contact Point</h4>
              </div>
              <div class="card-body">
                <ul class="sub-tab">
                  <li>
                    <a href="#" class="active">Referral or Contact Point</a>
                  </li>
                </ul>

                <div class="content-subtab">
                  <form class="g-3 mt-3" method="post" @submit.prevent="insertreferal">
                    <div class="row align-items-center">
                      <div class="col-md-7 mb-4">
                        ...
                        <input
                          type="text"
                          class="form-control"
                          placeholder="Enter Referral or Contact Point"
                          v-model="referal"
                        />
                      </div>
         ...
         <button type="submit" class="btn btn-warning btn-text" v-if="!settingId">
          <i class="fa fa-plus"></i> Add Parameter
                  ...
                  <div class="table-title">
                    <h3>List of Referral or Contact Point</h3>
                  </div>
                  <table
                  ...
                  >
                    <thead>
                      <tr>
                        ...
                        <th>Referral or Contact Point</th>
                        <th>Index</th>
                        <th>Status</th>
...
export default {
  ...
  name: "referral-or-contact-point",
  data() {
    return {
      referal: "",
      index: 0,
  ...
  methods: {
    async insertreferal() {
      ...
      try {
        if (!this.referal) {
          this.errorList.push("Referral-or-contact-point is required");
        }
        if (!this.index) {
          ...
          const response = await this.$axios.post(
            "/general-setting/add",
            {
              ...
              section: "referral-or-contact-point",
              section_value: this.referal,
...
this.$swal.fire(
    ...
    async GetSettingList() {
      ...
      const response = await this.$axios.get(
        "general-setting/lists?section=" + "referral-or-contact-point",
        { headers }
      );
    ...
    async editsetting(data) {
      ...
      if (response.data.code == 200) {
        ...
        this.referal = response.data.setting[0].section_value;
