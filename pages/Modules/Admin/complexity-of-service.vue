            ...
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-header icon-title">
                        ...
                        <h4>Complexity of Service</h4>
                    </div>
                    <div class="card-body">
                        <ul class="sub-tab">
                            <li>
                                <a href="#" class="active">Complexity of Service</a>
                            </li>
                        </ul>
                        ...
                        <div class="content-subtab">
                            <form class="g-3 mt-3" method="post" @submit.prevent="insertservices">
                                <div class="row align-items-center">
                                    <div class="col-md-7 mb-4">
                                        <label for="" class="form-label">Complexity of Service</label>
                                        <input type="text" class="form-control" placeholder="Enter Complexity of Service" v-model="services" />
                                    </div>
                            ...
                            <div class="table-title">
                                <h3>List of Complexity of Service</h3>
                            </div>
    ...
    methods: {
        ...
        async GetSettingList() {
            ...
            const response = await this.$axios.get(
                "general-setting/lists?section=" + "complexity-of-service", {
                    headers
                }
            );
