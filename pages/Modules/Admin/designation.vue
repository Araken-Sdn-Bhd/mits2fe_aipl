        ...
        <div class="container-fluid px-4">
          <div class="page-title">
            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                <ul class="sub-tab">
                  <li class=""><a href="#" class="active">Designation</a></li>
                </ul>
  ...
  methods: {
        ...
        if (!this.index) {
          ...
          const response = await this.$axios.post(
            "/general-setting/add",
            {
              ...
              section: "designation",
              section_value: this.designation,
    ...
    async GetSettingList() {
      ...
      const response = await this.$axios.get(
        "general-setting/lists?section=" + "designation",
        { headers }
      );
    ...
    async editsetting(data) {
      ...
      if (response.data.code == 200) {
        ...
        this.designation = response.data.setting[0].section_value;
