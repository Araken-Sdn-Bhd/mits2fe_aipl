          ...
          <div class="page-title">
            ...
            <div class="card mb-4">
              <div class="card-header icon-title">
                ...
                <h4>Type of Referral</h4>
              </div>
              <div class="card-body">
                <ul class="sub-tab">
                  <li class=""><a href="#" class="active">Type of Referral</a></li>
                </ul>
                  ...
                  <form class="g-3 mt-3" method="post" @submit.prevent="OnSubmit">
                    <div class="row align-items-center">
                      <div class="col-md-7 mb-4">
                        <label for="" class="form-label">Type of Referral</label>
                        <input
                          type="text"
                          class="form-control"
                          placeholder="Enter Type of Referral"
                          v-model="typeofreferral"
                        />
                      </div>
         ...
         <button type="submit" class="btn btn-warning btn-text" v-if="!settingId">
          <i class="fa fa-plus"></i> Add Parameter
                  ...
                  <div class="table-title">
                    <h3>List of Type of Referral</h3>
                  </div>
                  <table
        ...
        if (!this.index) {
          ...
          const response = await this.$axios.post(
            "/general-setting/add",
            {
              ...
              section: "type-of-referral",
              section_value: this.typeofreferral,
...
this.$swal.fire(
    ...
    async GetSettingList() {
      ...
      const response = await this.$axios.get(
        "general-setting/lists?section=" + "type-of-referral",
        { headers }
      );
    ...
    async editsetting(data) {
      ...
      if (response.data.code == 200) {
        ...
        this.typeofreferral = response.data.setting[0].section_value;
