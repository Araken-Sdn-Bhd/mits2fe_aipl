        ...
        <div class="container-fluid px-4">
          <div class="page-title">
            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                <ul class="sub-tab">
                  <li class=""><a href="#" class="active">External</a></li>
                </ul>
                  ...
                  <form class="g-3 mt-3" method="post" @submit.prevent="OnSubmit">
                    <div class="row align-items-center">
                      <div class="col-md-7 mb-4">
                        <label for="" class="form-label">External</label>
                        <input
                          type="text"
                          class="form-control"
...
export default {
  ...
  methods: {
    async OnSubmit() {
      ...
      try {
        if (!this.external) {
          this.errorList.push("External is required");
        }
        if (!this.index) {
...
this.$swal.fire(
    ...
    async editsetting(data) {
      ...
      if (response.data.code == 200) {
        ...
        this.external = response.data.setting[0].section_value;
