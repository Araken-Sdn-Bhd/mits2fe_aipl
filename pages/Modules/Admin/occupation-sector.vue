          ...
          <div class="page-title">
            ...
            <div class="card mb-4">
              <div class="card-header icon-title">
                ...
                <h4>Occupation Sector</h4>
              </div>
              <div class="card-body">
                <ul class="sub-tab">
                  <li class=""><a href="#" class="active">Occupation Sector</a></li>
                </ul>
         ...
         <button type="submit" class="btn btn-warning btn-text" v-if="!settingId">
          <i class="fa fa-plus"></i> Add Parameter
                  ...
                  <div class="table-title">
                    <h3>List of Occupation Sector</h3>
                  </div>
                  <table
...
export default {
  ...
  methods: {
    async OnSubmit() {
      this.errorList = [];
      try {
        if (!this.occupationsector) {
          this.errorList.push("Occupation Sector is required");
        }
        if (!this.index) {
          ...
          const response = await this.$axios.post(
            "/general-setting/add",
            {
              ...
              section: "occupation-sector",
              section_value: this.occupationsector,
...
this.$swal.fire(
    ...
    async GetSettingList() {
      ...
      const response = await this.$axios.get(
        "general-setting/lists?section=" + "occupation-sector",
        { headers }
      );
    ...
    async editsetting(data) {
      ...
      if (response.data.code == 200) {
        ...
        this.occupationsector = response.data.setting[0].section_value;
