          ...
          <div class="page-title">
            ...
            <div class="card mb-4">
              <div class="card-header icon-title">
                ...
                <h4>Medication Supervised By</h4>
              </div>
              <div class="card-body">
                <ul class="sub-tab">
                  <li class=""><a href="#" class="active">Medication Supervised By</a></li>
                </ul>
                  ...
                  <form class="g-3 mt-3" method="post" @submit.prevent="OnSubmit">
                    <div class="row align-items-center">
                      <div class="col-md-7 mb-4">
                        <label for="" class="form-label">Medication Supervised By</label>
                        <input
                          type="text"
                          class="form-control"
                          placeholder="Enter Medication Supervised By"
                          v-model="Medication"
                        />
                      </div>
         ...
         <button type="submit" class="btn btn-warning btn-text" v-if="!settingId">
          <i class="fa fa-plus"></i> Add Parameter
                  ...
                  <div class="table-title">
                    <h3>List of Medication Supervised By</h3>
                  </div>
                  <table
        ...
        if (!this.index) {
          ...
          const response = await this.$axios.post(
            "/general-setting/add",
            {
              ...
              section: "medication-supervised-by",
              section_value: this.Medication,
...
this.$swal.fire(
    ...
    async GetSettingList() {
      ...
      const response = await this.$axios.get(
        "general-setting/lists?section=" + "medication-supervised-by",
        { headers }
      );
    ...
    async editsetting(data) {
      ...
      if (response.data.code == 200) {
        ...
        this.Medication = response.data.setting[0].section_value;
