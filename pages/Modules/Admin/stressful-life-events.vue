          ...
          <div class="page-title">
            ...
            <div class="card mb-4">
              <div class="card-header icon-title">
                ...
                <h4>Stressful Life Events</h4>
              </div>
              <div class="card-body">
                <ul class="sub-tab">
                  <li>
                    <a href="#" class="active">Stressful Life Events</a>
                  </li>
                </ul>

                <div class="content-subtab">
                  <form class="g-3 mt-3" method="post" @submit.prevent="insertevents">
                    <div class="row align-items-center">
                      <div class="col-md-7 mb-4">
                        <label for="" class="form-label"
                          >Stressful Life Events</label
                        >
                        <input
                          type="text"
                          class="form-control"
                          placeholder="Enter Stressful Life Events"
                          v-model="events"
                        />
                      </div>
         ...
         <button type="submit" class="btn btn-warning btn-text" v-if="!settingId">
          <i class="fa fa-plus"></i> Add Parameter
                  ...
                  <div class="table-title">
                    <h3>List of Stressful Life Events</h3>
                  </div>
                  <table
...
export default {
  ...
  methods: {
    async insertevents() {
      ...
      try {
        if (!this.events) {
          this.errorList.push("Stressful-life-events is required");
        }
        if (!this.index) {
          ...
          const response = await this.$axios.post(
            "/general-setting/add",
            {
              ...
              section: "stressful-life-events",
              section_value: this.events,
...
this.$swal.fire(
    ...
    async GetSettingList() {
      ...
      const response = await this.$axios.get(
        "general-setting/lists?section=" + "stressful-life-events",
        { headers }
      );
    ...
    async editsetting(data) {
      ...
      if (response.data.code == 200) {
        ...
        this.events = response.data.setting[0].section_value;
