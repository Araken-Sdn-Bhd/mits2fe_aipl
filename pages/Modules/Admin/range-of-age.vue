          ...
          <div class="page-title">
            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                <ul class="sub-tab">
                  <li>
                    <a href="#" class="active">Range of Age</a>
                  </li>
                </ul>

                <div class="content-subtab">
                  <form class="g-3 mt-3" method="post" @submit.prevent="insertage">
                    <div class="row align-items-center">
                      <div class="col-md-7 mb-4">
                        <label for="" class="form-label">Range of Age</label>
                        <input
                          type="text"
                          class="form-control"
                          placeholder="Enter Range of Age"
                          v-model="age"
                        />
                      </div>
...
export default {
  ...
  methods: {
    async insertage() {
      ...
      try {
        if (!this.age) {
          this.errorList.push("Range-of-age is required");
        }
        if (!this.index) {
          ...
          const response = await this.$axios.post(
            "/general-setting/add",
            {
              ...
              section: "range-of-age",
              section_value: this.age,
...
this.$swal.fire(
    ...
    async GetSettingList() {
      ...
      const response = await this.$axios.get(
        "general-setting/lists?section=" + "range-of-age",
        { headers }
      );
    ...
    async editsetting(data) {
      ...
      if (response.data.code == 200) {
        ...
        this.age = response.data.setting[0].section_value;
