        ...
        <div class="container-fluid px-4">
          ...
          <div class="card mb-4">
            <div class="card-header icon-title">
              ...
              <h4>Overdose / Poisoning</h4>
            </div>
            <div class="card-body">
              <ul class="sub-tab">
                <li>
                  <a href="#" class="active">Overdose / Poisoning</a>
                </li>
              </ul>
                  ...
                  <div class="row align-items-center">
                    <div class="col-md-7 mb-4">
                      ...
                      <input
                        type="text"
                        class="form-control"
                        placeholder="Enter Overdose / Poisoning"
                        v-model="overdose"
                      />
                    </div>
...
export default {
  ...
  methods: {
    async insertoverdose() {
      this.errorList = [];
      try {
        if (!this.overdose) {
          this.errorList.push("Overdose-poisoning is required");
        }
        if (!this.index) {
          ...
          const response = await this.$axios.post(
            "/general-setting/add",
            {
              ...
              section: "overdose-poisoning",
              section_value: this.overdose,
...
this.$swal.fire(
    ...
    async GetSettingList() {
      ...
      const response = await this.$axios.get(
        "general-setting/lists?section=" + "overdose-poisoning",
        { headers }
      );
    ...
    async editsetting(data) {
      ...
      if (response.data.code == 200) {
        ...
        this.overdose = response.data.setting[0].section_value;
