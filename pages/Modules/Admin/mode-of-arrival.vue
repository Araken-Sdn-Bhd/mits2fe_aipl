          ...
          <div class="page-title">
            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                <ul class="sub-tab">
                  <li>
                    <a href="#" class="active"> Mode of Arrival</a>
                  </li>
                </ul>

                <div class="content-subtab">
                  <form class="g-3 mt-3" method="post" @submit.prevent="insertmodeofarrival">
                    <div class="row align-items-center">
                      <div class="col-md-7 mb-4">
                        <label for="" class="form-label">Mode of Arrival</label>
                        <input
                          type="text"
                          class="form-control"
...
export default {
  ...
  methods: {
    async insertmodeofarrival() {
      ...
      try {
        if (!this.arrival) {
          this.errorList.push("Mode-of-arrival is required");
        }
        if (!this.index) {
          ...
          const response = await this.$axios.post(
            "/general-setting/add",
            {
              ...
              section: "mode-of-arrival",
              section_value: this.arrival,
...
this.$swal.fire(
    ...
    async GetSettingList() {
      ...
      const response = await this.$axios.get(
        "general-setting/lists?section=" + "mode-of-arrival",
        { headers }
      );
    ...
    async editsetting(data) {
      ...
      if (response.data.code == 200) {
        ...
        this.arrival = response.data.setting[0].section_value;
