            ...
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-header icon-title">
                        ...
                        <h4>Compliance To Treatment</h4>
                    </div>
                    <div class="card-body">
                        <ul class="sub-tab">
                            <li class=""><a href="#" class="active">Compliance To Treatment</a></li>
                        </ul>
                        ...
                        <div class="content-subtab">
                            <form class="g-3 mt-3" method="post" @submit.prevent="OnSubmit">
                                <div class="row align-items-center">
                                    <div class="col-md-7 mb-4">
                                        <label for="" class="form-label">Compliance To Treatment</label>
                                        <input type="text" class="form-control" placeholder="Enter Compliance To Treatment" v-model="compliancetotreatment " />
                                    </div>
                            ...
                            <div class="table-title">
                                <h3>List of Compliance To Treatment</h3>
                            </div>
                ...
                if (!this.index) {
                    ...
                    const response = await this.$axios.post(
                        "/general-setting/add", {
                            ...
                            section: "compliance-to-treatment",
                            section_value: this.compliancetotreatment,
