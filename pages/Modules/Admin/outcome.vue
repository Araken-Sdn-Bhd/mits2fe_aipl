        ...
        <div class="container-fluid px-4">
          <div class="page-title">
            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                <ul class="sub-tab">
                  <li><a  class="active" href="#">Outcome</a></li>
                </ul>

                <div class="content-subtab">
                  <form class="g-3 mt-3" method="post" @submit.prevent="insertoutcome">
                    <div class="row align-items-center">
                      <div class="col-md-7 mb-4">
                        <label for="" class="form-label">Outcome</label>
                        <input
                          type="text"
                          class="form-control"
...
this.$swal.fire(
    ...
    async GetSettingList() {
      ...
      const response = await this.$axios.get(
        "general-setting/lists?section=" + "outcome",
        { headers }
      );
    ...
    async editsetting(data) {
      ...
      if (response.data.code == 200) {
        ...
        this.outcome = response.data.setting[0].section_value;
