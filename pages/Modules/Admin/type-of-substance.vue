          ...
          <div class="page-title">
            ...
            <div class="card mb-4">
              <div class="card-header icon-title">
                ...
                <h4>Type of Substance</h4>
              </div>
              <div class="card-body">
                <ul class="sub-tab">
                  <li>
                    <a href="#" class="active">Type of Substance</a>
                  </li>
                </ul>

                <div class="content-subtab">
                  <form class="g-3 mt-3" method="post" @submit.prevent="inserttype">
                    <div class="row align-items-center">
                      <div class="col-md-7 mb-4">
                        <label for="" class="form-label"
                          >Type of Substance</label
                        >
                        <input
                          type="text"
                          class="form-control"
                          placeholder="Enter Type of Substance"
                          v-model="substance"
                        />
                      </div>
         ...
         <button type="submit" class="btn btn-warning btn-text" v-if="!settingId">
          <i class="fa fa-plus"></i> Add Parameter
                  ...
                  <div class="table-title">
                    <h3>List of Type of Substance</h3>
                  </div>
                  <table
...
export default {
  ...
  methods: {
    async inserttype() {
      ...
      try {
        if (!this.substance) {
          this.errorList.push("Type-of-substance is required");
        }
        if (!this.index) {
          ...
          const response = await this.$axios.post(
            "/general-setting/add",
            {
              ...
              section: "type-of-substance",
              section_value: this.substance,
    ...
    async GetSettingList() {
      ...
      const response = await this.$axios.get(
        "general-setting/lists?section=" + "type-of-substance",
        { headers }
      );
    ...
    async editsetting(data) {
      ...
      if (response.data.code == 200) {
        ...
        this.substance = response.data.setting[0].section_value;
