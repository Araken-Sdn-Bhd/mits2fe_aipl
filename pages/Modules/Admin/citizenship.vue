        ...
        <main>
            ...
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <ul class="sub-tab">
                            <li class=""><a href="#" class="active">Citizenship</a></li>
                        </ul>
                            ...
                            <form class="g-3 mt-3" method="post" @submit.prevent="OnSubmit">
                                <div class="row align-items-center">
                                    <div class="col-md-7 mb-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter citizenship" v-model="citizenship" />
                                    </div>
    ...
    methods: {
        ...
        async GetSettingList() {
            ...
            const response = await this.$axios.get(
                "general-setting/lists?section=" + "citizenship", {
                    headers
                }
            );
        ...
        async editsetting(data) {
            ...
            if (response.data.code == 200) {
                ...
                this.citizenship = response.data.setting[0].section_value;
