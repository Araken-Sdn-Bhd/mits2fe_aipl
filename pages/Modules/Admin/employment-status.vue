        ...
        <div class="container-fluid px-4">
          <div class="page-title">
            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                <ul class="sub-tab">
                  <li class=""><a href="#" class="active">Employment Status</a></li>
                </ul>
         ...
         <button type="submit" class="btn btn-warning btn-text" v-if="!settingId">
          <i class="fa fa-plus"></i> Add Parameter
                  ...
                  <div class="table-title">
                    <h3>List of Employment Status</h3>
                  </div>
                  <table
...
this.$swal.fire(
    ...
    async GetSettingList() {
      ...
      const response = await this.$axios.get(
        "general-setting/lists?section=" + "employment-status",
        { headers }
      );
    ...
    async editsetting(data) {
      ...
      if (response.data.code == 200) {
        ...
        this.employye = response.data.setting[0].section_value;
