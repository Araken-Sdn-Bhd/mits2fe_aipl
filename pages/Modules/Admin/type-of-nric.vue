        ...
        <div class="container-fluid px-4">
          <div class="page-title">
            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                <ul class="sub-tab">
                  <li class=""><a href="#" class="active">Type of NRIC</a></li>
                </ul>
                  ...
                  <form class="g-3 mt-3" method="post" @submit.prevent="OnSubmit">
                    <div class="row align-items-center">
                      <div class="col-md-7 mb-4">
                        <label for="" class="form-label">Type of NRIC</label>
                        <input
                          type="text"
                          class="form-control"
                          placeholder="Enter type of nric"
                          v-model="typeofnric"
                        />
                      </div>
...
export default {
  ...
  methods: {
    async OnSubmit() {
      ...
      try {
        if (!this.typeofnric) {
          this.errorList.push("type-of-nric is required");
        }
        if (!this.index) {
          ...
          const response = await this.$axios.post(
            "/general-setting/add",
            {
              ...
              section: "type-of-nric",
              section_value: this.typeofnric,
...
this.$swal.fire(
    ...
    async GetSettingList() {
      ...
      const response = await this.$axios.get(
        "general-setting/lists?section=" + "type-of-nric",
        { headers }
      );
    ...
    async editsetting(data) {
      ...
      if (response.data.code == 200) {
        ...
        this.typeofnric = response.data.setting[0].section_value;
