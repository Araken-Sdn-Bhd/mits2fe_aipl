          ...
          <div class="page-title">
            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                <ul class="sub-tab">
                  <li>
                    <a href="#" class="active">Patient Category</a>
                  </li>
                </ul>

                <div class="content-subtab">
                  <form class="g-3 mt-3" method="post" @submit.prevent="insertcategory">
         ...
         <button type="submit" class="btn btn-warning btn-text" v-if="!settingId">
          <i class="fa fa-plus"></i> Add Parameter
                  ...
                  <div class="table-title">
                    <h3>List of Patient Category</h3>
                  </div>
                  <table
...
export default {
  ...
  methods: {
    async insertcategory() {
      ...
      try {
        if (!this.category) {
          this.errorList.push("Patient-category is required");
        }
        if (!this.index) {
