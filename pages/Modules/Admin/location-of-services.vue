          ...
          <div class="page-title">
            ...
            <div class="card mb-4">
              <div class="card-header icon-title">
                ...
                <h4>Location of Services</h4>
              </div>
              <div class="card-body">
                <ul class="sub-tab">
                  <li class=""><a href="#" class="active">Location of Services</a></li>
                </ul>
                  ...
                  <form class="g-3 mt-3" method="post" @submit.prevent="OnSubmit">
                    <div class="row align-items-center">
                      <div class="col-md-7 mb-4">
                        <label for="" class="form-label">Location of Services</label>
                        <input
                          type="text"
                          class="form-control"
                          placeholder="Enter Location of Services"
                          v-model="locationofservices"
                        />
                      </div>
         ...
         <button type="submit" class="btn btn-warning btn-text" v-if="!settingId">
          <i class="fa fa-plus"></i> Add Parameter
                  ...
                  <div class="table-title">
                    <h3>List of Location of Services</h3>
                  </div>
                  <table
        ...
        if (!this.index) {
          ...
          const response = await this.$axios.post(
            "/general-setting/add",
            {
              ...
              section_value: this.locationofservices,
...
this.$swal.fire(
    ...
    async GetSettingList() {
      ...
      const response = await this.$axios.get(
        "general-setting/lists?section=" + "location-of-services",
        { headers }
      );
    ...
    async editsetting(data) {
      ...
      if (response.data.code == 200) {
        ...
        this.locationofservices = response.data.setting[0].section_value;
