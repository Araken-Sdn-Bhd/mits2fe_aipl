            ...
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-header icon-title">
                        ...
                        <h4>Current Intervention</h4>
                    </div>
                    <div class="card-body">
                        <ul class="sub-tab">
                            <li class=""><a href="#" class="active">Current Intervention</a></li>
                        </ul>
                        ...
                        <div class="content-subtab">
                            <form class="g-3 mt-3" method="post" @submit.prevent="OnSubmit">
                                <div class="row align-items-center">
                                    <div class="col-md-7 mb-4">
                                        <label for="" class="form-label">Current Intervention</label>
                                        <input type="text" class="form-control" placeholder="Enter Current Intervention" v-model="currentintervention" />
                                    </div>
                            ...
                            <div class="table-title">
                                <h3>List of Current Intervention</h3>
                            </div>
    ...
    methods: {
                ...
                if (!this.index) {
                    ...
                    const response = await this.$axios.post(
                        "/general-setting/add", {
                            ...
                            section: "current-interventionl",
                            section_value: this.currentintervention,
        ...
        async GetSettingList() {
            ...
            const response = await this.$axios.get(
                "general-setting/lists?section=" + "current-interventionl", {
                    headers
                }
            );
        ...
        async editsetting(data) {
            ...
            if (response.data.code == 200) {
                ...
                this.currentintervention = response.data.setting[0].section_value;
