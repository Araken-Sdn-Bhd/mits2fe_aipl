            ...
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-header icon-title">
                        ...
                        <h4>Assistance or Supervision</h4>
                    </div>
                    <div class="card-body">
                        <ul class="sub-tab">
                            <li class=""><a href="#" class="active">Assistance or Supervision</a></li>
                        </ul>
                            ...
                            <form class="g-3 mt-3" method="post" @submit.prevent="OnSubmit">
                                <div class="row align-items-center">
                                    <div class="col-md-7  mb-4">
                                        <label for="" class="form-label">Assistance or Supervision</label>
                                        <input type="text" class="form-control" placeholder="Enter Assistance or Supervision" v-model="assistanceorsupervision" />
                                    </div>
...
export default {
    ...
    name: "assistance-or-supervision",
    data() {
        return {
    ...
    methods: {
        async OnSubmit() {
            this.errorList = [];
            try {
                if (!this.assistanceorsupervision) {
                    this.errorList.push("Assistance or Supervision is required");
                }
                if (!this.index) {
                    ...
                    const response = await this.$axios.post(
                        "/general-setting/add", {
                            ...
                            section: "assistance-or-supervision",
                            section_value: this.assistanceorsupervision,
