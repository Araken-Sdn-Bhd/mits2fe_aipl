                                    ...
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            ...
                                            <div class="add-box">
                                                ...
                                                <td>
                                                    <span class="add-td"> <a href="#"><i class="fa fa-plus"></i></a></span>
                                                </td>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" aria-label="Default select example" v-model="appointment_patient_category">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" aria-label="Default select example" v-model="appointment_type_visit">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" aria-label="Default select example" v-model="appointment_assign_team">
