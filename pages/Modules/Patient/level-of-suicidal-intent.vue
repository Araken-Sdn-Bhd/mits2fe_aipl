        ...
        <div class="container-fluid px-4">
          ...
          <div class="card mb-4">
            <div class="card-header bg-transparent">
              <h4>LEVEL OF SUICIDAL INTENT (Beck's Suicide Intent Scale)</h4>
            </div>
            <div class="card-body">
              <div class="row mr-0 mt-3 suicidal-intent">
...
export default {
  ...
  methods: {
    async GetList() {
      ...
      console.log("level-of-suicidal-intent", response.data);
        ...
        if (this.list.length == Object.values(this.checkedList).length) {
          ...
          const response = await this.$axios.post(
            "patient/online-test",
            {
              ...
              result: JSON.stringify([{ SI: this.checkedList }]),
