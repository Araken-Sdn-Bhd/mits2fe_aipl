            ...
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4 overflow-hidden">
                    <div class="card-body patient-registration">
                        <ul class="nav nav-pills icon-tab disabled" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active demographic-active" id="pills-demographic-tab1" data-bs-toggle="pill" data-bs-target="#pills-demographic1" role="tab" aria-controls="pills-demographic1" aria-selected="true" ref="tab1">
                                    <i class="fad fa-user"></i>
                                    <span>1: Demographic</span>
                                </a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="pills-socio-demographic-tab1" data-bs-toggle="pill" data-bs-target="#pills-socio-demographic1" role="tab" aria-controls="pills-socio-demographic1" aria-selected="false" ref="tab2">
                                    <i class="fad fa-id-card"></i>
                                    <span>2: Socio Demographic</span>
                                </a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="pills-next-of-kin-tab1" data-bs-toggle="pill" data-bs-target="#pills-next-of-kin1" role="tab" aria-controls="pills-next-of-kin1" aria-selected="false" ref="tab3">
                                    <i class="fad fa-users"></i>
                                    <span>3: Next of Kin</span>
                                </a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link allergy-active" id="pills-allergy-tab1" data-bs-toggle="pill" data-bs-target="#pills-allergy1" role="tab" aria-controls="pills-allergy1" aria-selected="false" ref="tab4">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-demographic" role="tabpanel" aria-labelledby="pills-demographic-tab" ref="navdiv1">
                                <div class="content-subtab border-0">
                                    <form>
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    ...
                                                    <select v-model="salutation_id" class="form-select" aria-label="Default select example">
                                                        <option value="0">Select Salutation</option>
                                                        <option v-for="slt in salutationlist" v-bind:key="slt.id" v-bind:value="slt.id">
                                                            {{ slt.section_value }}
                                                        </option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-sm-7">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter Name (As In NRIC)" name="" v-model="name_asin_nric" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- close-row -->
                                        ...
                                        <div class="row mt-3 align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="radio radio-show">
                                                    <div class="form-check form-check-inline col-sm-3" v-for="(ct, i) in citizenshiplist" :key="i">
                                                        <input class="form-check-input" type="radio" name="inlineRadioOptions" v-bind:id="'ct' + i" v-bind:value="ct.id" v-model="citizenship" @change="OnchangeCitizenship(ct.section_value,ct.id)" />
                                            ...
                                            <div class="malaysian box mb-0" v-if="citizentype == 'Malaysian'">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select v-model="nric_type" class="form-select" aria-label="Default select example" v-on:change="resetModelValue">
                                                    ...
                                                    <div class="col-sm-6" v-if="this.nric_type_code == 'OIC'">
                                                        ...
                                                        <input type="tel" class="form-control toCapitalFirst" placeholder="xxxxxxxx" @keyup="OnnricNo4" v-model="nric_no" />
                                                        <Error :message="error" v-if="error" />
                                                    </div>
                                                    <div class="col-sm-6" v-if="this.nric_type_code == 'NIC'">
                                                        <label class="form-label toCapitalFirst">New NRIC No<small>*</small></label>
                                                        <input type="tel" class="form-control" placeholder="xxxxxx-xx-xxxx" @keyup="OnnricNo" v-model="nric_no" @change="validateIC" v-on:keypress="NumbersOnly" />
                                                        <Error :message="error" v-if="error" />
                                                    </div>
                                                    <div class="col-sm-6" v-if="this.nric_type_code == 'POL'">
                                                        <label class="form-label">Police ID<small>*</small></label>
                                                        <input type="tel" class="form-control toCapitalFirst" placeholder="xxxxxxxxx" @keyup="OnnricNo3" v-model="nric_no" />
                                                        <Error :message="error" v-if="error" />
                                                    </div>
                                                    <div class="col-sm-6" v-if="this.nric_type_code == 'ARM'">
                                                        <label class="form-label">Army ID<small>*</small></label>
                                                        <input type="tel" class="form-control toCapitalFirst" placeholder="xxxxxxxx" v-model="nric_no" />
                                                        <Error :message="error" v-if="error" />
                                                    </div>
                                                    <div class="col-sm-6" v-if="this.nric_type_code == 'BC'">
                                            ...
                                            <div class="permanent-resident box mb-0" v-if="citizentype == 'Permanent Resident'">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="xxxxxx-xx-xxxx" @keyup="OnnricNo1" v-model="nric_no1" @change="validateIC" v-on:keypress="NumbersOnly" />
                                                        <Error :message="error" v-if="error" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-9 mb-3">
                                                <div class="radio">
                                                    <div class="form-check form-check-inline col-sm-2" v-for="(gn, i) in genderlist" :key="i">
                                                        <input class="form-check-input" type="radio" name="Sex" v-bind:id="'gn' + i" v-bind:value="gn.id" v-model="sex" />
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label class="form-label">Mobile Phone No.<small>*</small></label>
                                                    <input type="tel" class="form-control" name="" v-mask="'###-########'" placeholder="xxx-xxxxxxxx" v-model="mobile_no" />
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label class="form-label">House Phone No.</label>
                                                    <input type="tel" class="form-control" v-mask="'##-########'" placeholder="xx-xxxxxxxx" name="" v-model="house_no" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- close-row -->
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="" placeholder="Enter Hospital's MRN No." v-model="hospital_mrn_no" />
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label class="form-label">Mentari's MRN No.</label>
                                                    <input type="text" class="form-control" placeholder="Mentari's MRN No." name="" v-model="mintari_mrn_no" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- close-row -->
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    ...
                                                    <select v-model="services_type" class="form-select" aria-label="Default select example" @change="onservicechange($event)">
                                                        <option value="0">Select</option>
                                                        <option v-for="src in servicelist" v-bind:key="src.id" v-bind:value="{id: src.id, text: src.service_name}">
                                                            {{ src.service_name }}
                                                        </option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="mb-3 rehabilitation selected-box" v-if="uploaddoc">
                                                    <label class="form-label">Upload Referral Letter</label>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    ...
                                                    <select v-model="referral_type" class="form-select" aria-label="Default select example" @change="OnchangeReferral($event)">
                                                        <option value="0">Select</option>
                                            ...
                                            <div class="col-sm-6" v-if="otherReferral">
                                                <div class="mb-3">
                                                    <label class="form-label">Please Specify</label>
                                                    <input type="text" class="form-control" v-model="other_referral" placeholder="please specify other referral" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- close-row -->
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control mb-2" placeholder="Enter Street Address" name="" v-model="address1" />
                                                    <input type="text" class="form-control mb-2" placeholder="Enter Street Address" name="" v-model="address2" />
                                                    <input type="text" class="form-control mb-2" placeholder="Enter Street Address" name="" v-model="address3" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- close-row -->
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    ...
                                                    <select v-if="dataReady" disabled v-model="branchId" class="form-select" aria-label="Default select example">

                                                        <option v-for="brnch in branchlist" v-bind:key="brnch.id" v-bind:value="brnch.id">
                                                            {{ brnch.hospital_branch_name }}
                                                        </option>
                                                    </select>
                                                    <select v-if="dataReady2" v-model="branchId" class="form-select" aria-label="Default select example">
                                                        <option v-for="brnch in branchlist" v-bind:key="brnch.id" v-bind:value="brnch.id">
                                                            {{ brnch.hospital_branch_name }}
                                                        </option>
                                                    </select>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <a @click="NextFirst" class="btn btn-primary btn-fill btn-md ml-auto">Next <i class="fad fa-arrow-to-right"></i></a>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="pills-socio-demographic" role="tabpanel" aria-labelledby="pills-socio-demographic-tab" ref="navdiv2">
                                <div class="content-subtab border-0">
                                    <form>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select v-model="race_id" class="form-select" aria-label="Default select example" @change="OnchangeRace($event)">
                                                        <option value="0">Select</option>
                                            ...
                                            <div class="col-sm-6" v-if="otherRace">
                                                <div class="mb-3">
                                                    <label class="form-label">Please Specify</label>
                                                    <input type="text" class="form-control" v-model="other_race" placeholder="please specify other race" />
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    <label class="form-label">Religion</label>
                                                    <select v-model="religion_id" class="form-select" aria-label="Default select example" @change="OnchangeReligion($event)">
                                                        <option value="0">Select</option>
                                            ...
                                            <div class="col-sm-6" v-if="otherReligion">
                                                <div class="mb-3">
                                                    <label class="form-label">Please Specify</label>
                                                    <input type="text" class="form-control" v-model="other_religion" placeholder="please specify other religion" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- close-row -->
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select v-model="marital_id" class="form-select" aria-label="Default select example" @change="OnchangeMarital($event)">
                                                        <option value="0">Select</option>
                                            ...
                                            <div class="col-sm-6" v-if="otherMarital">
                                                <div class="mb-3">
                                                    <label class="form-label">Please Specify</label>
                                                    <input type="text" class="form-control" v-model="other_maritalList" placeholder="please specify other marital status" />
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    <label class="form-label">Accommodation</label>
                                                    <select v-model="accomodation_id" class="form-select" aria-label="Default select example" @change="OnchangeAccommodation($event)">
                                                        <option value="0">Select</option>
                                                        <option v-for="acco in accommodationlist" v-bind:key="acco.id" v-bind:value="acco.id">
                                                            {{ acco.section_value }}
                                                        </option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-sm-6" v-if="otherAccommodation">
                                                <div class="mb-3">
                                                    <label class="form-label">Please Specify</label>
                                                    <input type="text" class="form-control" v-model="other_accommodation" placeholder="please specify other accommodation" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- close-row -->
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select v-model="fee_exemption_status" class="form-select" aria-label="Default select example" @change="OnchangeFee($event)">
                                                        <option value="0">Select</option>
                                                        <option v-for="fee in feeexemptionlist" v-bind:key="fee.id" v-bind:value="fee.id">
                                                            {{ fee.section_value }}
                                                        </option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-sm-6" v-if="otherFeeExemStatus">
                                                <div class="mb-3">
                                                    <label class="form-label">Please Specify</label>
                                                    <input type="text" class="form-control" v-model="other_feeExemptionStatus" placeholder="please specify other fee exemption status" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select v-model="occupation_status" class="form-select" aria-label="Default select example" @change="OnchangeOccStatus($event)">
                                                        <option value="0">Select</option>
                                                        <option v-for="ocu in occupationlist" v-bind:key="ocu.id" v-bind:value="ocu.id">
                                                            {{ ocu.section_value }}
                                                        </option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-sm-6" v-if="otherOccStatus">
                                                <div class="mb-3">
                                                    <label class="form-label">Please Specify</label>
                                                    <input type="text" class="form-control" v-model="other_occupationStatus" placeholder="please specify other occupation status" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- close-row -->
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select v-model="education_level" class="form-select" aria-label="Default select example" @change="OnchangeEducation($event)">
                                                        <option value="0">Select</option>
                          ...
                          />
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select v-model="occupation_sector" class="form-select" aria-label="Default select example">
                                                        <option value="0">Select</option>
                                                        <option v-for="sec in occupationsectorlist" v-bind:key="sec.id" v-bind:value="sec.id">
                                                            {{ sec.section_value }}
                                                        </option>
                                                    </select>
                                                </div>
                                        ...
                                        <br><br>
                                        <div class="d-flex align-items-center">
                                            <a @click="PreviousFirst" class="btn btn-primary btn-fill btn-md"><i class="fad fa-arrow-to-left"></i> Previous</a>

                                            <a @click="NextSecond" class="btn btn-primary btn-fill btn-md ml-auto">Next <i class="fad fa-arrow-to-right"></i></a>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="pills-next-of-kin" role="tabpanel" aria-labelledby="pills-next-of-kin-tab" ref="navdiv3">
                                <div class="content-subtab border-0">
                                    <form>
                                        <div class="row">
                                            <div class="col-sm-7">
                                                <div class="mb-3">
                                                    <label class="form-label">Name (As In NRIC)<small></small></label>
                                                    <input type="text" class="form-control" placeholder="Enter Name (As In NRIC)" name="" v-model="kin_name_asin_nric" />
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label class="form-label">Relationship<small></small></label>
                                                    <select v-model="kin_relationship_id" class="form-select" aria-label="Default select example">
                                                        <option value="0">Select</option>
                                                        <option v-for="relation in relationshiplist" v-bind:key="relation.id" v-bind:value="relation.id">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="tel" class="form-control toCapitalFirst" v-model.number="kin_nric_no" />
                                                    <Error :message="error" v-if="error" />
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label class="form-label">Mobile Phone No.<small></small></label>
                                                    <input type="tel" class="form-control" name="" v-mask="'###-########'" placeholder="xxx-xxxxxxxx" v-model="kin_mobile_no" />
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label class="form-label">House Phone No.</label>
                                                    <input type="tel" class="form-control" v-mask="'##-########'" placeholder="xx-xxxxxxxx" name="" v-model="kin_house_no" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- close-row -->
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="mb-3">
                                                    <label class="form-label">Address</label>
                                                    <input type="text" class="form-control mb-2" placeholder="Enter Street Address" name="" v-model="kin_address1" />
                                                    <input type="text" class="form-control mb-2" placeholder="Enter Street Address" name="" v-model="kin_address2" />
                                                    <input type="text" class="form-control mb-2" placeholder="Enter Street Address" name="" v-model="kin_address3" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- close-row -->
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label class="form-label">State</label>
                                                    <select v-model="kin_state_id" class="form-select" aria-label="Default select example" @change="onKinSelectedState($event)">
                                                        <option value="0">Select</option>
                                                        <option v-for="st in statelist" v-bind:key="st.id" v-bind:value="st.id">
                                                            {{ st.state_name }}
                                                        </option>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <label class="form-label">Postcode</label>
                                                    <select v-model="kin_postcode" class="form-select" aria-label="Default select example">
                                                        <option value="0">Select</option>
                                                        <option v-for="ct in kinpostcodelist" v-bind:key="ct.id" v-bind:value="ct.id">
                                                            {{ ct.postcode }}
                                                        </option>
                                                    </select>
                                                </div>
                                        ...
                                        <br><br>
                                        <div class="d-flex align-items-center">
                                            <a @click="PreviousSecnd" class="btn btn-primary btn-fill btn-md"><i class="fad fa-arrow-to-left"></i> Previous</a>

                                            <a @click="NextThird" class="btn btn-primary btn-fill btn-md ml-auto">Next <i class="fad fa-arrow-to-right"></i></a>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="pills-allergy" role="tabpanel" aria-labelledby="pills-allergy-tab" ref="navdiv4">
                                <div class="content-subtab border-0">
                                    <form>
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="drug-allergy" id="da-yes" value="0" v-model="drug_allergy" />
                                                    <label class="form-check-label" for="da-yes">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="drug-allergy" id="da-no" value="1" v-model="drug_allergy" />
                                                    <label class="form-check-label" for="da-no">No</label>
                                                </div>
                                            </div>

                                            <!-- div-hide -->
                                            <div class="col-sm-5" v-if="this.drug_allergy == '0'">
                                                <input type="email" class="form-control" id="" placeholder="To Specify" v-model="drug_allergy_description" />
                                            </div>
                                        </div>
                                        <!-- close-row -->
                                        ...
                                        <div class="row align-items-center mb-3">
                                            <div class="col-sm-5">
                                                <label class="form-label mb-0">Traditional Medication/Supplement Allergy</label>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="tm-sa" id="TM-SA-yes" value="0" v-model="traditional_medication" />
                                                    <label class="form-check-label" for="TM-SA-yes">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="tm-sa" id="TM-SA-no" value="1" v-model="traditional_medication" />
                                                    <label class="form-check-label" for="TM-SA-no">No</label>
                                                </div>
                                            </div>

                                            <!-- div-hide -->
                                            <div class="col-sm-5" v-if="this.traditional_medication=='0'">
                                                <input type="email" class="form-control" id="" placeholder="To Specify" v-model="traditional_description" />
                                            </div>
                                        </div>
                                        <!-- close-row -->
                                        ...
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="others-allergy" id="oa-yes" value="0" v-model="other_allergy" />
                                                    <label class="form-check-label" for="oa-yes">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="others-allergy" id="oa-no" value="1" v-model="other_allergy" />
                                                    <label class="form-check-label" for="oa-no">No</label>
                                                </div>
                                            </div>

                                            <!-- div-hide -->
                                            <div class="col-sm-5" v-if="this.other_allergy=='0'">
                                                <input type="email" class="form-control" id="" placeholder="To Specify" v-model="other_description" />
                                            </div>
                                        </div>
                                        <div class="row align-items-center mb-3" v-if="!Id">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="patient-triage-yes" id="screen-yes" value="1" v-model="patient_need_triage_screening" />
                                                    <label class="form-check-label" for="screen-yes">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="patient-triage-yes" id="screen-no" value="0" v-model="patient_need_triage_screening" />
                                                    <label class="form-check-label" for="screen-no">No</label>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- close-row -->
                                        ...
                                        <br><br>
                                        <div class="d-flex align-items-center">
                                            <a @click="PreviousThird" class="btn btn-primary btn-fill btn-md"><i class="fad fa-arrow-to-left"></i> Previous</a>

                                            <a v-if="Id && SidebarAccess==1" @click="updateRegistration" class="btn btn-primary btn-fill btn-md ml-auto"><i class="fa fa-save"></i> Update</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
